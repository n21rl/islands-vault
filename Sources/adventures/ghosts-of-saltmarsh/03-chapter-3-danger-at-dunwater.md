...
Judging from a crude map found aboard the smugglers' vessel and from information provided by the sea elf [Oceanus](Published/bestiary/npc/oceanus-gos.md), it seems likely that the lizardfolk are preparing for war. The council members hope that the townspeople are not the intended target, but they greatly fear this possibility.
...
The lizardfolk have not approached Saltmarsh with an offer to join the alliance because [Othokent](Published/bestiary/npc/othokent-gos.md), their queen, considers humans and other land-dwelling races as of little use in a battle to be fought largely underwater.
...
| Earn trust of [Sauriv](Published/bestiary/npc/sauriv-gos.md) | 10 | +10 |
| Earn trust of [Othokent](Published/bestiary/npc/othokent-gos.md) | 15 | +15 |
^charisma-check-benefits
...
In particular, the great crocodile called [Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md) is an ongoing problem for the tribe. If the characters are shy of 50 points and out of options, you can have the queen bring up this opportunity. See "Epilogue: Croc Hunt" at the end of the adventure. Slaying the crocodile earns the characters 10 points.
...
![Lizardfolk Names – General](Published/tables/lizardfolk-names-general-gos.md)
...
If the characters want to travel by sea, the council places at their disposal a modified [keelboat](Published/vehicles/keelboat.md) with two pairs of oars and a step-down mast, large enough to accommodate the characters and any reasonable amount of equipment they want to take with them. Navigation and propulsion of the craft is handled by two members of the town guard ([guards](Published/bestiary/humanoid/guard.md)), who are assigned by the council to sail or row the boat. The guards do not disembark when the characters reach their destination, instead staying with the boat to keep it under their control and guard the party's return trip.
...
**Wave 1**. Six [bullywugs](Published/bestiary/humanoid/bullywug.md) attempt to surprise the characters, leaping from the muddy water to attack.

**Wave 2**. Arrp ([bullywug croaker](Published/bestiary/humanoid/bullywug-croaker-gos.md); see appendix C) and two [bullywugs](Published/bestiary/humanoid/bullywug.md) arrive shortly after the first wave is defeated. They make a grand show of battling the characters, and Arrp grins at the king whenever he is effective in combat.

**Wave 3**. Gulpa'Gor ([bullywug royal](Published/bestiary/humanoid/bullywug-royal-gos.md); see appendix C) arrives mounted on a [giant toad](Published/bestiary/beast/giant-toad.md) shortly after Arrp and his guards are slain.
...
The bullywugs' treasure consists of 325 pp and a [helm of underwater action](Published/items/helm-of-underwater-action-gos.md) (see appendix B) in which the loose coins are contained. It can be easily discovered nearby after all the bullywugs are dealt with.
...
|------|--------------------|-------|
| 2 | 5 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) | These guards are alerted by noise in 1. If they are challenged, one of the guards tries to escape to 3 for help. |
| 3 | 3 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | If a guard from 2 escaped, these guards go to 2. If not, they remain here until alerted by noise nearby. |
| 5 | 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | This officer is alerted by noise in 3. The guards in 2 and 3, if they are still present, join the officer in this room when they hear sounds of battle. |
| 7 | 5 [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md)* | The kitchen workers escape to 9 if allowed to do so. |
| 9 | 4 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md),*1 [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) | These guards go to 7 if a commoner escapes to warn them of the characters in that room. Otherwise they remain here. |
| 10 | 5 [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md)* | The banquet workers escape to 29 if allowed to do so. The characters might accompany them. |
| 11 | 2 hatchlings | Friendly hatchlings (noncombatants) latch onto the characters if they're not discouraged from doing so. |
| 12 | 2 [amphisbaenae](Published/bestiary/monstrosity/amphisbaena-gos.md)*, 1 [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) | The shaman tries to flee to the west. If it does so, it races to 20 looking for help. |
| 20 | 2 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) | These lizardfolk go to 12, responding to the threat if alerted by the shaman that escaped from that area. |
| 22 | 6 [giant lizards](Published/bestiary/beast/giant-lizard.md) | The giant lizards remain here until encountered. No amount of noise or disruption will coax the reptiles elsewhere. |
| 23 | 3 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) | These lizardfolk go to 22 if alerted by sounds of combat there. They go to 24 if a commoner escapes from that room and arrives here. |
| 24 | 20 [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md),* 13 hatchlings | These lizardfolk protect hatchlings (noncombatants) and guard the entrance to 25. If combat starts, two commoners try to flee to 23 and get help. |
| 25 | 3 hatchlings | The hatchlings (noncombatants) remain here. |
| 26 | 5 [giant poisonous snakes](Published/bestiary/beast/giant-poisonous-snake.md) | The snakes remain here. |
| 27 | 1 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md)* | These lizardfolk move toward the gate if alerted by noise in that area. Otherwise they remain here. |
| 29 | 4 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md),*1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These lizardfolk go to 10 if a commoner escapes to warn them of the characters in that room. Otherwise they remain here. |
| 32 | 3 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These lizardfolk remain here until encountered. |
| 35 | 2 [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md)* | These commoners try to flee to 36 if attacked. |
| 38 | [Sauriv](Published/bestiary/npc/sauriv-gos.md) (lizardfolk [noble](Published/bestiary/humanoid/noble.md)) | The minister (noncombatant) remains here unless the characters fail to win his favor. If that happens, he tries to flee to 40. |
| 40 | 1 [lizard queen](Published/bestiary/humanoid/lizard-king.md), 1 [lizardfolk subchief](Published/bestiary/humanoid/lizardfolk-subchief-gos.md),* 2 [lizardfolk scaleshields](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md),* 1 [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md),* 8 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) | These lizardfolk remain here until encountered, unwilling to jeopardize the queen's defense by leaving. |
| 42 | 3 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These guards go to the gate at 41 (north) in response to noise there. Otherwise they remain here until encountered. If that happens, one tries to flee to 44 to get reinforcements. |
| 43a | 1 [sahuagin](Published/bestiary/humanoid/sahuagin.md) | The sahuagin remains here unless the characters release it. |
| 43e | 1 [lizardfolk commoner](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) | The commoner remains here unless the characters release it. If that happens, it tries to flee to 44. |
| 44 | 2 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), 1 [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md)* | These guards go to 42, 48, or 52 if alerted to the presence of characters in those areas. Otherwise they remain here until encountered. |
| 48 | 4 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) | These guards go to the gate at 41 (south) in response to noise there. If they hear sounds of combat in 52, three go there and one goes to 44 for added help. |
| 49 | 4 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) | If these lizardfolk become aware of intruders, one goes to 42 and elsewhere looking for reinforcements. Another one goes to 50, 51, and 52 in succession to alert the occupants there. |
| 50 | 3 [koalinth](Published/bestiary/humanoid/koalinth-gos.md),* 1 [koalinth sergeant](Published/bestiary/humanoid/koalinth-sergeant-gos.md)* | The koalinth go to 49 if alerted to the presence of intruders there, eager to support their lizardfolk allies. |
| 51 | 4 [locathah](Published/bestiary/humanoid/locathah-gos.md),* 1 [locathah hunter](Published/bestiary/humanoid/locathah-hunter-gos.md),*5 [giant sea eels](Published/bestiary/beast/giant-sea-eel-gos.md)* | The locathah and their eels go to 49 if alerted to the presence of intruders there. |
| 52 | 3 [merfolk](Published/bestiary/humanoid/merfolk.md), 1 [merfolk salvager](Published/bestiary/humanoid/merfolk-salvager-gos.md)* | The merfolk go to 49 if alerted to the presence of intruders there, cooperating with their allies. |
^lizardfolk-roster

### Communication and Disposition

In this adventure, the queen, the subchief Irhtos, the shamans, and the scaleshields can speak and understand the Common tongue. The aged lizardfolk minister, [Sauriv](Published/bestiary/npc/sauriv-gos.md), is fluent and literate in Common. All other lizardfolk speak only Draconic and are illiterate.
...
The lizardfolk patrol the corridors of their lair routinely. Unless the characters are extremely stealthy and careful, they are bound to encounter a patrol at some point. A guard patrol consists of two [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), one of which carries a torch (because the corridors are normally unlit), and one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C).
...
Five [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) are always on duty here. If the characters make any noise in the nearby corridor, one of the guards comes out to investigate. On seeing intruders, he shouts to his comrades and then challenges the characters, demanding in Draconic that they retreat. The other guards join him immediately.
...
There are three [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) in this room forming up under one officer ([lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md); see appendix C) to go on patrol in the lair.
...
The officer ([lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md); see appendix C) leaps up, ready to fight, as soon as the characters enter.
...
The five [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) fight only if they are cornered. Otherwise, they escape to the nearest barracks (area 9), whose occupants return to the kitchen in the shortest possible time.
...
If they have not been called elsewhere, four [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C), and one [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) prepare for patrol in this room.
...
The five [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) fight only if they are cornered. Otherwise, they escape to the nearest barracks (area 29), whose occupants return to the banquet hall in the shortest possible time.
...
You can elect not to name the creatures but simply give detailed physical descriptions, leaving the players to make the identifications. If [Oceanus](Published/bestiary/npc/oceanus-gos.md) accompanies the party, he can identify the sharks, the giant frog, the giant crayfish, and the sahuagin.
...
A single [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) worships at the altar in this room. Two [amphisbaenae](Published/bestiary/monstrosity/amphisbaena-gos.md) (see appendix C) serve as guardians here, and live within the hollow altar.
...
A [lizardfolk shaman](Published/bestiary/humanoid/lizardfolk-shaman.md) is leading two disciples ([lizardfolk](Published/bestiary/humanoid/lizardfolk.md)) in a short prayer to Semuanya.
...
Three [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) keep guard in this room, alert for unusual sounds coming from the north or south. If the guards have not moved elsewhere, they are sitting on the bench, talking and keeping their weapons near.
...
There are twenty [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) and thirteen lizardfolk hatchlings here. The hatchlings do not fight and pose no threat to the party.
...
Inside the pit are five [giant poisonous snakes](Published/bestiary/beast/giant-poisonous-snake.md), which attack anything that falls in.
...
A [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md) (see appendix C) and a [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) occupy this area, ordered to stand guard over the lair's treasure (area 26). They do not open the gate unless commanded to do so by the queen or the subchief.
...
Four [lizardfolk](Published/bestiary/humanoid/lizardfolk.md), one [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md) (see appendix C), and one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) are in this chamber, awaiting their turn at patrol duty, if they have not been called elsewhere.
...
Three [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) and one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) stand guard here. The guards immediately challenge any approaching characters. They have been selected specifically to guard the approach to their queen's quarters. Charisma (Intimidation) and Charisma (Persuasion) checks against these guards are made with disadvantage. The characters must present a convincing story to get access to area 33 and beyond; otherwise they must leave the area immediately.
...
Unless extreme circumstances prevail (for example, the guards in area 32 have beaten a fighting retreat here), two [lizardfolk commoners](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) reside here, playing a game at the table.
...
[Sauriv](Published/bestiary/npc/sauriv-gos.md) is extremely wise, and it is due to his inspiration that the strategy of forging an alliance against the sahuagin was devised. He arranged for the purchase of the weapons the *Sea Ghost* has been transporting (as related in The Sinister Secret of Saltmarsh).
...
[Othokent](Published/bestiary/npc/othokent-gos.md), Irhtos ([lizardfolk subchief](Published/bestiary/humanoid/lizardfolk-subchief-gos.md)), and two [lizardfolk scaleshields](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) observe eight [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) and one [lizardfolk render](Published/bestiary/humanoid/lizardfolk-render-gos.md) as they train for battle (see appendix C for all but the [lizardfolk](Published/bestiary/humanoid/lizardfolk.md)).

[Othokent](Published/bestiary/npc/othokent-gos.md) is a [lizard queen](Published/bestiary/humanoid/lizard-king.md), with these changes:
...
Three [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) and one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) stand guard here. Melee in this area is not heard by the occupants of area 44, but if one of the guards escapes, it goes there and calls for help.
...
If the sea elf is with the party, he recognizes the sahuagin on sight and immediately identifies it for the characters. [Oceanus](Published/bestiary/npc/oceanus-gos.md) advises strongly against allying with it and accepting its assistance. If the rest of the characters overrule him, he tries to kill the sahuagin then and there. If unassisted and uninterrupted, [Oceanus](Published/bestiary/npc/oceanus-gos.md) kills the weakened sahuagin in 2 rounds.
...
A [lizardfolk commoner](Published/bestiary/humanoid/lizardfolk-commoner-gos.md) (see appendix C) has been kept here for a few days as a disciplinary measure. It hisses and cowers in the corner if approached. It escapes to area 44 if it can.
...
Two [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) and one [lizardfolk scaleshield](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) are seated at the table, playing a dice game for copper pieces.
...
Four [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) are stationed here. These guards hear any sounds of melee in area 52. If this happens, three of them go immediately to that area, and the fourth goes to area 44 to summon reinforcements.
...
Four [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) hide in the seaweed of the pool.
...
One [locathah hunter](Published/bestiary/humanoid/locathah-hunter-gos.md), four [locathah](Published/bestiary/humanoid/locathah-gos.md), and their five [giant sea eels](Published/bestiary/beast/giant-sea-eel-gos.md) occupy this pool (see appendix C for each).
...
One [merfolk salvager](Published/bestiary/humanoid/merfolk-salvager-gos.md) (see appendix C) and three [merfolk](Published/bestiary/humanoid/merfolk.md) are beneath the algae.
...
Either as a way of apologizing for making a bad first impression on the lizardfolk, or to provide some extra excitement for combat-loving characters, this encounter pits the party against a terrible foe that dwells in the deepest muck of the swamps. [Queen Othokent](Published/bestiary/npc/othokent-gos.md) details the threat, telling the characters a story about a creature the lizardfolk call [Thousand Teeth the Devourer](Published/bestiary/npc/thousand-teeth-gos.md). Roleplay a conversation with the queen, or summarize the conversation using the following information:
...
- There would be no violation of sacred taboo if the adventurers were to kill the giant crocodile on the queen's behalf. In fact, the queen demands the head of [Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md) be brought to her so that she might add it to her collection.  

If the party agrees to solve the tribe's crocodile problem, Queen [Othokent](Published/bestiary/npc/othokent-gos.md) offers them a vile-tasting flask of swamp water mashed with various roots (a potion of superior healing).

### Lair of the Devourer

[Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md)'s pool is located along the Dunwater River, about twelve miles inland from the lizardfolk lair.
...
| dice: d8 | Result |
|----------|--------|
| 1 | 6 hungry [giant frogs](Published/bestiary/beast/giant-frog.md) |
| 2 | 1 [troll](Published/bestiary/giant/troll.md) eating crabs |
| 3 | 2 [cult fanatics](Published/bestiary/humanoid/cult-fanatic.md) performing a ritual |
| 4 | 3 [swarms of insects (wasps)](Published/bestiary/beast/swarm-of-wasps.md) defending their nest |
| 5 | 1 [druid](Published/bestiary/humanoid/druid.md) (evil-aligned) and two [swarms of rats](Published/bestiary/beast/swarm-of-rats.md) |
| 6 | 4 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) (not from the queen's lair) |
| 7 | 1 injured (half hit points) [treant](Published/bestiary/plant/treant.md) beset by 6 [swarms of rats](Published/bestiary/beast/swarm-of-rats.md) |
| 8 | 2 [ogres](Published/bestiary/giant/ogre.md), lost in the marsh |
^marsh-random-encounters
...
The pool is 8 feet deep at its center. The water is polluted from the rotting remains of [Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md)'s meals, and any creature that ingests more than a spoonful must succeed on a DC 12 Constitution saving throw or be poisoned for 1 hour.

In addition to [Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md) (see appendix C) in its muddy mound, two [giant constrictor snakes](Published/bestiary/beast/giant-constrictor-snake.md) lurk in the canopy of vines and drop down on unsuspecting creatures that linger too long at the pool's edge. A character who has a passive Perception score of 15 or more notices the snakes before they attack.

##### Development

[Thousand Teeth](Published/bestiary/npc/thousand-teeth-gos.md) currently sleeps in its muddy mound. Its nose is nearly invisible where it pokes above the water. If any creature enters its pool, or if loud sounds are made near the pool's edge (such as combat with giant snakes), the crocodile awakens and slides through the water to investigate. If it does interrupt combat with the canopy-dwelling serpents, the snakes flee into the trees to escape.