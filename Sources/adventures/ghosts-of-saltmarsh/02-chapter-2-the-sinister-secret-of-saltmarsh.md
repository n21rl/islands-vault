...
The following members of the gang are currently in the house, skulking about in the cellar and the adjoining caverns: [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) (see appendix C), two [hobgoblins](Published/bestiary/humanoid/hobgoblin.md), four [bandits](Published/bestiary/humanoid/bandit.md), and four [scouts](Published/bestiary/humanoid/scout.md). All the bandits and scouts are humans of neutral evil alignment. Before being alerted to the characters' incursion the smugglers are dispersed in the cellar and caverns beneath the house (as indicated in the area descriptions).

##### Smugglers on Alert

In the likely event that the characters betray their presence (likely by triggering one of the magic mouth spells in areas 4 and 10), the smugglers become aware of the party before encountering them. [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) and three of his gang (a [hobgoblin](Published/bestiary/humanoid/hobgoblin.md), a [bandit](Published/bestiary/humanoid/bandit.md), and a [scout](Published/bestiary/humanoid/scout.md)) immediately retreat to areas 27 and 28 to protect the smuggled goods.

The others break into two groups. Two [bandits](Published/bestiary/humanoid/bandit.md) and a [scout](Published/bestiary/humanoid/scout.md) wait in area 21 to ambush intruders. The second hobgoblin keeps watch at area 30, but runs to reinforce [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) in area 27 if a fight breaks out there. The remaining members of the gang, two scouts and a bandit, try to ambush intruders. They make Dexterity (Stealth) checks to close in on the party. If two of them are slain, the survivor tries to flee back to area 21.
...
The smugglers currently run weapons for a clan of lizardfolk living near Saltmarsh whose queen, [Othokent](Published/bestiary/npc/othokent-gos.md), is preparing her clan for battle against a terrible enemy: the sahuagin.
...
The characters discover a document that explains the signaling system used by the smugglers to indicate the ship has arrived; by deciphering and sending the proper return signal, they can put the crew at ease. By force or deception, the party boards the *Sea Ghost* and attempts to seize control. During this raid, the party encounters a captured sea elf named [Oceanus](Published/bestiary/npc/oceanus-gos.md) and a trio of lizardfolk warriors. The adventure concludes with signs that the lizardfolk are preparing for a raid, presumably on the town of Saltmarsh—though the truth, as outlined in the "Portents of War" section, is far more ominous.
...
Two [giant poisonous snakes](Published/bestiary/beast/giant-poisonous-snake.md) make their homes in the crumbled and crevice-ridden walls of the well shaft. They emerge and strike at anything that descends into the well. They also emerge if the characters linger near the well while investigating it.
...
A [swarm of insects (spiders)](Published/bestiary/beast/swarm-of-spiders.md) lurks in the crevices of the fireplace and chimney. The spiders flood forth with obvious irritation if any creatures move to within 5 feet of the fireplace.
...
Four [giant centipedes](Published/bestiary/beast/giant-centipede.md) nest under the floor below the sink. They come and go through a hole in the foundation beneath the kitchen. The centipedes skitter up the drain, enter the room, and attack anyone investigating the cupboard or the sink.
...
[Sanbalet](Published/bestiary/npc/sanbalet-gos.md) has cast a magic mouth spell on the stairs, which is triggered when anyone treads on the top step. If the spell is set off, hideous screams—as if of a soul in torment—rise from the cellar below.
...
Two [swarms of insects (spiders)](Published/bestiary/beast/swarm-of-spiders.md) infest this room. One swarm descends on anyone who approaches the fireplace, and the other descends from the webs above the door a moment later. Both wash down the walls with the muffled clatter of thousands of tiny legs.
...
A group of six [stirges](Published/bestiary/beast/stirge.md) nests in the rafters of the attic. They descend on the party at an opportune moment, revealing themselves after the characters enter the attic.
...
The corpse is infested with two [swarms of rot grubs](Published/bestiary/beast/swarm-of-rot-grubs-vgm.md) (see appendix C). Any creature that touches the body comes under attack by the swarms as they spill out of gaps in the armor. At a glance, the grubs' appearance looks unnervingly similar to curdled milk being squeezed from a bladder.
...
If the characters avoided making undue noise in area 20, a single smuggler ([bandit](Published/bestiary/humanoid/bandit.md)) is scrubbing pots in a washbasin near the stove. He tries to flee through the secret door as soon as the characters appear. Otherwise, if the smugglers have been alerted to the party's presence, two [bandits](Published/bestiary/humanoid/bandit.md) and a [scout](Published/bestiary/humanoid/scout.md) are here and ready to fight.
...
If the characters have avoided alerting the smugglers to their presence, [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) (see appendix C) is in his quarters. Otherwise, this room is vacant.

[Sanbalet](Published/bestiary/npc/sanbalet-gos.md)'s books consists of the following volumes:
...
Inside the third book is a sheet of parchment featuring a few simple words and phrases in the Common tongue and their equivalents in Goblin. The words include "stop," "fight," "lift," "come," and so forth—key words used by [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) to instruct his hobgoblin mercenaries.
...
A character who makes a successful DC 12 Intelligence (Investigation) check finds a hidden compartment under the table that holds [Sanbalet](Published/bestiary/npc/sanbalet-gos.md)'s spellbook. The book contains all the spells [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) has prepared.

The small wooden box holds twelve candles, flint and steel, and a piece of parchment that details [Sanbalet](Published/bestiary/npc/sanbalet-gos.md)'s method of communicating with the ship. See "The Signaling System" in the second part of this adventure for more information.
...
Six old [skeletons](Published/bestiary/undead/skeleton-xphb.md) lurk in the shadows here. They rise and attack as soon as the characters enter the room. They have disadvantage on initiative checks owing to the length of their dormancy. The skeletons are reinforced by compounds applied to their bones years ago. The first time they take damage from a melee attack, that damage is reduced by half. If the skeletons are vulnerable to that damage, they instead ignore that vulnerability for this attack.

##### Development

If the characters spend more than a few moments here, a faint blue light appears at the seam of the secret door to area 24. The light gradually grows brighter as the alchemist's remains reanimate after long decades. At a time of your choosing, the alchemist ([skeletal alchemist](Published/bestiary/undead/skeletal-alchemist-gos.md); see appendix C) emerges through the secret door to assist the skeletons.
...
The alchemist wears an empty bag of holding at the waist. One rib bone on each of the skeletons is dipped in gold and is worth 5 gp. The alchemist also carries a [cursed luckstone](Published/items/cursed-luckstone-gos.md) (see appendix B).
...
If the smugglers are not yet aware of the characters' presence, three [scouts](Published/bestiary/humanoid/scout.md) are resting here while they await instructions. There is nothing else of note in this area.
...
This is the primary storage chamber for [Sanbalet](Published/bestiary/npc/sanbalet-gos.md)'s smuggling operation, and the likely place from which he and his gang mount a defense.

If an alarm has not been raised, two [bandits](Published/bestiary/humanoid/bandit.md) and a [scout](Published/bestiary/humanoid/scout.md) are here, stealing drinks from the store of brandy.

If the smugglers have been alerted, [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) (see appendix C and the following sidebar), one [hobgoblin](Published/bestiary/humanoid/hobgoblin.md), one [scout](Published/bestiary/humanoid/scout.md), and one [bandit](Published/bestiary/humanoid/bandit.md) defend this room. [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) stays clear of the melee, taking cover behind the casks in the southeast corner. The hobgoblin and the bandit try to prevent the characters from entering the room, while the scout hangs back to fire its ranged weapon.
...
[Sanbalet](Published/bestiary/npc/sanbalet-gos.md) carries a [pipe of remembrance](Published/items/pipe-of-remembrance-gos.md) (see appendix B) and a set of masterfully crafted loaded gaming dice (20 gp). The hobgoblin wears a suit of mariner's armor (scale mail).

> [!note] Sanbalet
> 
> A tall man with a shaved head and piercing green eyes, the leader of the smugglers is as charismatic as he is cunning. [Sanbalet](Published/bestiary/npc/sanbalet-gos.md) is a plotting nemesis who prefers manipulation to direct action. It is no accident that his gang occupies the old house, since the promise of hidden knowledge initially drew him here.
> 
...
> 
> **Confidence Aplenty.** [Sanbalet](Published/bestiary/npc/sanbalet-gos.md)'s success stems from confidence in his abilities. He delights in criminal behavior and considers himself a great villain. He speaks of himself in the third person and exhibits narcissistic tendencies.
^sanbalet
...
A lone [bandit](Published/bestiary/humanoid/bandit.md) is here if the smugglers aren't on alert.

If either of the magic mouth spells has been triggered, a lone [hobgoblin](Published/bestiary/humanoid/hobgoblin.md) keeps watch here (guarding against an approach by sea) and joins the fray in area 27 if it hears sounds of combat.
...
If the characters have avoided triggering either of the magic mouth spells, the two [hobgoblin](Published/bestiary/humanoid/hobgoblin.md) smugglers are standing guard here.
...
Aside from Captain Sigurd "Snake Eyes" ([pirate captain](Published/bestiary/humanoid/pirate-captain-gos.md); see appendix C), the crew of the *Sea Ghost* consists of the following members:

- Bloody Bjorn, a [pirate first mate](Published/bestiary/humanoid/pirate-first-mate-gos.md) (see appendix C)  
- Foul Frithoff, a [pirate bosun](Published/bestiary/humanoid/pirate-bosun-gos.md) (see appendix C)  
- Punketah, a [pirate deck wizard](Published/bestiary/humanoid/pirate-deck-wizard-gos.md) (see appendix C)  
- 7 crew members ([bandits](Published/bestiary/humanoid/bandit.md))  
- 3 [lizardfolk](Published/bestiary/humanoid/lizardfolk.md)  
...
The two figures are Bloody Bjorn ([pirate first mate](Published/bestiary/humanoid/pirate-first-mate-gos.md); see appendix C) and a crew member ([bandit](Published/bestiary/humanoid/bandit.md)).
...
The figure is a single crew member ([bandit](Published/bestiary/humanoid/bandit.md)) watching for any signals from shore.
...
The figure leaning against the tiller is a crew member ([bandit](Published/bestiary/humanoid/bandit.md)). The others, from fore to aft, are Punketah ([pirate deck wizard](Published/bestiary/humanoid/pirate-deck-wizard-gos.md); see appendix C), the ship's captain Sigurd "Snake Eyes" ([pirate captain](Published/bestiary/humanoid/pirate-captain-gos.md); see appendix C) and another crew member ([bandit](Published/bestiary/humanoid/bandit.md)). The last holds a bullseye lantern that has a shutter over its lens; from time to time the crew member moves the shutter and sends out the prearranged signal.
...
Three [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) warriors occupy the hammocks. The chest and its contents are their property. The lizardfolk were provided by the chieftain of their clan to help ensure that the smuggled weapons in area 15 make it to their lair. When they become aware of the characters, they initially assume they are smugglers and treat them as such, demanding in a combination of Draconic and broken Common to know when the weapons will be delivered to their kinfolk.

A [pseudodragon](Published/bestiary/dragon/pseudodragon-xphb.md) named Bimz sleeps in a small nest behind the chest. It is the companion of one of the lizardfolk and joins in the combat to defend its master.
...
This cabin is the private quarters of Punketah, the [deck wizard](Published/bestiary/humanoid/pirate-deck-wizard-gos.md). On a peg behind the door hangs a maroon robe, of no particular value.
...
The first drawer contains two potions of healing, a dose of antitoxin, and the key that unlocks the chains holding [Oceanus](Published/bestiary/npc/oceanus-gos.md) in area 14.
...
Four crew members ([bandits](Published/bestiary/humanoid/bandit.md)) under the supervision of Foul Frithoff ([pirate bosun](Published/bestiary/humanoid/pirate-bosun-gos.md); see appendix C) are wandering about the hold, securing the cargo and taking inventory. They chat about all manner of depraved conquests as they do. Once they become aware of the party, they attack immediately.
...
The prisoner in area 14 might hear the characters in the bosun's cabin. [Oceanus](Published/bestiary/npc/oceanus-gos.md) shouts to attract their attention if he overhears someone speaking Aquan or Elvish.

##### Treasure

The sea chest is unlocked and contains, grubby garments of no value. Concealed by the garments is a locked (but not trapped) iron box. The key to the box is in Foul Frithoff's belt pouch. The box can be opened by a character who succeeds on a DC 10 Dexterity check using thieves' tools. It contains 200 sp, a spear, a dagger, and the remains of a crossbow. The weapons belong to [Oceanus](Published/bestiary/npc/oceanus-gos.md), the sea elf who is imprisoned in area 14. The crossbow is damaged beyond repair.
...
The figure is that of a sea elf; the key to unlock his chains can be found in the captain's writing desk drawer (see area 9). If the characters demonstrate friendship and release him, [Oceanus](Published/bestiary/npc/oceanus-gos.md) (see appendix C) has an interesting story to relate and will assist the characters to the best of his ability in their undertaking. [Oceanus](Published/bestiary/npc/oceanus-gos.md) speaks Aquan as well as Elvish.

If invited to do so, he joins the characters with enthusiasm and stays with them throughout the conclusion of this adventure. He will, if requested to do so, remain with the characters for further adventures (assuming that they continue with *Danger at Dunwater* and possibly also *The Final Enemy*), in which circumstances you could ask one of the players to play [Oceanus](Published/bestiary/npc/oceanus-gos.md). At all times he will be as cooperative as possible, playing a full role as an NPC in the party's undertakings (he will, of course, expect a normal portion of treasure). Afterward, he reluctantly leaves them to return home.

> [!note] A Prisoner from the Deep
> 
> Assuming that the characters befriend [Oceanus](Published/bestiary/npc/oceanus-gos.md) and have a way to communicate with him, the elf provides the following information.
> 
> **How He Became Imprisoned.** [Oceanus](Published/bestiary/npc/oceanus-gos.md) is a member of the tribe of Manaan, which inhabits an undersea settlement about twenty miles southeast of Saltmarsh. He was stripped of his weapons and armor when imprisoned, but though bruised and hungry, he has suffered no great injury and his spirit is undaunted.
> 
> His tribe has noted, from a distance, the periodic travels of the *Sea Ghost* at night along a supposedly deserted coastal area. Suspicious of this behavior, the tribal chief ordered [Oceanus](Published/bestiary/npc/oceanus-gos.md) to keep watch on this area, slip aboard when the ship arrived, and follow the ship back to its port of origin to discover what he could of these strange proceedings. This [Oceanus](Published/bestiary/npc/oceanus-gos.md) did, and at the vessel's home port he witnessed the stowing aboard of a small arsenal of weaponry. He was then discovered, knocked out, and taken prisoner. He awakened some time later, chained to the ship's hull in this compartment.
> 
...
A number of [rats](Published/bestiary/beast/rat-xphb.md) eke out a precarious existence here, but they are of the normal variety and harmless. The bilge offers only 4 feet of headroom.

Two [swarms of rot grubs](Published/bestiary/beast/swarm-of-rot-grubs-vgm.md) (see appendix C) live in the garbage island around the mast. A gold coin among the trash is the source of the reflection. The rot grubs attack anyone who comes near.
