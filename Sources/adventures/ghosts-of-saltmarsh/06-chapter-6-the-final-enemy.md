...
Two [lizardfolk scaleshields](Published/bestiary/humanoid/lizardfolk-scaleshield-gos.md) (see appendix C) named Garurt and Vyth represent their queen's interests. They are severe, no-nonsense soldiers. The lizardfolk have set up a camp outside Saltmarsh where a dozen warriors are quartered, with the prospect of more to come. Assuming the lizardfolk are present at the meeting, they provide precious information to the council about their former lair (see "A Great Gift").

### Merfolk

A single [merfolk salvager](Published/bestiary/humanoid/merfolk-salvager-gos.md) (see appendix C) named Aryn represents her colony in the meeting. She dislikes being on land and has trouble moving across the cobbled streets of Saltmarsh. Aryn is one of six merfolk occupying a kelp bed near the docks of Saltmarsh.

### Locathah

Sakith, a [locathah hunter](Published/bestiary/humanoid/locathah-hunter-gos.md) (see appendix C), joins the meeting as the representative for his tribe. A dozen [locathah](Published/bestiary/humanoid/locathah-gos.md) and their [giant sea eel](Published/bestiary/beast/giant-sea-eel-gos.md) steeds swim in the waters near Saltmarsh (see appendix C for both).
...
If the characters want to travel by sea, the council provides them with a modified [keelboat](Published/vehicles/keelboat.md) with two pairs of oars, two rowboats, and a step-down mast, large enough to accommodate the characters and any reasonable amount of equipment. Navigation and propulsion of the craft is handled by two members of the town guard ([guards](Published/bestiary/humanoid/guard.md)), who pilot the boat but do not disembark when the characters reach their destination. (If the characters experienced Danger at Dunwater, this boat is of the same sort as the one they used in that adventure.)
...
A patrol consists of five [sahuagin](Published/bestiary/humanoid/sahuagin.md), one [sahuagin coral smasher](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) drawn from the roster in area 24. If that area is depleted of sahuagin, no more patrols are sent out.
...
The guards who are rowing or sailing the [keelboat](Published/vehicles/keelboat.md) won't come anywhere within several hundred feet of the island. They prefer to drop off the characters (in their rowboats) on the eastern edge of the area, but if the characters ask, they will sail around the south side of the island—always giving it a wide berth—so the characters can disembark somewhere else along the perimeter.
...
|------|--------------------|-------|
| 1 | 6 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 2 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md)* | These guards are alerted by intruders they become aware of. If one of them rings the gong three times, sahuagin in 2 and 12 rush to their aid. |
| 2 | 2 [sahuagin](Published/bestiary/humanoid/sahuagin.md) | These guards go to 1 if they hear combat or if the gong is rung three times. |
| 12 | 5 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 2 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*2 [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) | These sahuagin go to 1 if the gong is rung three times or if they are alerted by a guard from 2. |
| 13 | Elmo the slave ([commoner](Published/bestiary/humanoid/commoner.md)) | Elmo is near death and cannot be moved. |
| 19 | 2 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 4 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin priestess](Published/bestiary/humanoid/sahuagin-priestess.md), 10 slaves | These sahuagin go to 12 if they hear sounds of combat from that area. The slaves remain here. |
^sahuagin-roster-level-1
...
| Area | Occupants at Start | Notes |
|------|--------------------|-------|
| 23 | 2 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 2 [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) | These sahuagin remain here until encountered. |
| 24 | 25 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 5 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*5 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md)* | Guard patrols are drawn from this area until all the occupants are defeated. |
| 25 | 3 [sahuagin hatchling swarms](Published/bestiary/beast/sahuagin-hatchling-swarm-gos.md)* | If the swarms emerge, 5 sahuagin and 1 coral smasher come here from 24. |
| 26 | 2 [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md), 2 [sahuagin hatchling swarms](Published/bestiary/beast/sahuagin-hatchling-swarm-gos.md)* | The swarms emerge if the priestesses are alerted. The priestesses try to flee to 24; if one does so, it returns with 5 sahuagin and 1 coral smasher. |
| 27 | 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 12 [sahuagin](Published/bestiary/humanoid/sahuagin.md),12 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* | These sahuagin remain here until encountered. |
| 28 | 1 [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | The wave shaper goes to 27 if alerted by sounds of combat there, arriving on the third round. |
| 29 | 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 10 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 6 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),* 4 [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md),* 4 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These sahuagin remain here until encountered. |
| 30 | 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md)* | The champion goes to 29 if alerted by sounds of combat there. |
| 34 | 1 [sahuagin priestess](Published/bestiary/humanoid/sahuagin-priestess.md), 4 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 37 | [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md),* 3 [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) | These creatures remain here until encountered. |
| 39 | 10 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 42 | Kepmak ([sahuagin baron](Published/bestiary/humanoid/sahuagin-baron.md)), Thadrah ([sahuagin high priestess](Published/bestiary/humanoid/sahuagin-high-priestess-gos.md)*), 2 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin](Published/bestiary/humanoid/sahuagin.md),2 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 45 | Seklaz ([sahuagin baron](Published/bestiary/humanoid/sahuagin-baron.md)), 1 [sahuagin](Published/bestiary/humanoid/sahuagin.md),1 [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | If combat occurs, the sahuagin tries to escape. If it does so, it returns with 5 sahuagin and 1 coral smasher in 5 rounds. |
^sahuagin-roster-level-2
...
| Area | Occupants at Start | Notes |
|------|--------------------|-------|
| 48 | 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 4 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),*1 [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 2 [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md)* | The wave shaper escapes to level 2 if possible. If it does so, it returns with a patrol in `3d6 + 6` rounds. |
| 50 | 3 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [locathah](Published/bestiary/humanoid/locathah-gos.md)* (captive) | These sahuagin go to 52 if alerted by sounds of combat there. |
| 50b | [Sea lion](Published/bestiary/monstrosity/sea-lion-tftyp.md)* | The sea lion attacks if released, unless [Kysh](Published/bestiary/npc/kysh-gos.md) the triton is present. |
| 50d | [Kysh](Published/bestiary/npc/kysh-gos.md)* | [Kysh](Published/bestiary/npc/kysh-gos.md) offers to join the party if he is released. |
| 51 | 5 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
...
| 53 | Makaht ([sahuagin blademaster](Published/bestiary/humanoid/sahuagin-blademaster-gos.md)*), 49 [sahuagin](Published/bestiary/humanoid/sahuagin.md),5 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md)* | These sahuagin remain here until encountered. |
| 54 | 20 [sahuagin](Published/bestiary/humanoid/sahuagin.md) | These sahuagin remain here until encountered. |
| 55 | 2 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md)* | These sahuagin go to 54 if alerted by sounds of combat there. |
| 56 | 2 [sahuagin wave shapers](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 6 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 2 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | These creatures remain here until encountered. |
| 57 | 1 [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md)* | The wave shaper goes to 56 if alerted by sounds of combat there. |
| 58 | 2 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 6 [sahuagin](Published/bestiary/humanoid/sahuagin.md) | These sahuagin go to 54 if alerted by sounds there, arriving in 3 rounds. |
| 59 | 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 1 [sahuagin](Published/bestiary/humanoid/sahuagin.md) | These sahuagin remain here until encountered. |
| 60 | 45 [sahuagin](Published/bestiary/humanoid/sahuagin.md), 10 [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md),* 7 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md),* 4 [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md),* 2 [sahuagin wave shapers](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md),* 6 [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md)* | Twelve sahuagin and 2 coral smashers go to 52 if the stone slab there is shattered. Otherwise these creatures remain here until encountered. |
^sahuagin-roster-level-3
...
Six [sahuagin](Published/bestiary/humanoid/sahuagin.md), two [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and one [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) guard the entrance. If the door is forced open, one of the sahuagin immediately moves toward the west wall to ring the gong, while the remaining guards defend the entrance. If this creature is slain or otherwise prevented from ringing the gong, no other defender takes its place.
...
Two [sahuagin](Published/bestiary/humanoid/sahuagin.md) stationed in area 2 are not initially visible to the characters. They are responsible for keeping guard over the gate that separates the entrance from the rest of the lair.
...
Two [sahuagin](Published/bestiary/humanoid/sahuagin.md) stand guard in this room. They attack intruders attempting to enter the fortress.

The pulley mechanism is described in area 1.

##### Development

If the gong in area 1 has not been rung and the fight at the entrance is going badly for the defenders, one of the sahuagin tries to flee to area 12 to summon reinforcements. It returns with the guards posted in area 12 (five [sahuagin](Published/bestiary/humanoid/sahuagin.md), two [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) [see appendix C], and two [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md)) in 10 rounds.
...
Unless they were called to help in areas 1 and 2, five [sahuagin](Published/bestiary/humanoid/sahuagin.md), two [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), and two [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) occupy this room.
...
One human slave ([commoner](Published/bestiary/humanoid/commoner.md)) named Elmo lies dying in the northwest corner of this room. Elmo is too weak to call out to the characters, though he can speak with them if they approach.
...
There are ten slaves in this area: four [orcs](Published/bestiary/humanoid/orc.md), four [hobgoblins](Published/bestiary/humanoid/hobgoblin.md), and two [lizardfolk](Published/bestiary/humanoid/lizardfolk.md). See the "Slaves of the Sahuagin" sidebar for more information.

Four [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C), one [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C), one [sahuagin priestess](Published/bestiary/humanoid/sahuagin-priestess.md), and two [sahuagin](Published/bestiary/humanoid/sahuagin.md) oversee the work of the slaves. The sahuagin attack any intruders on sight.
...
Two **[sahuagin](Published/bestiary/humanoid/sahuagin.md) champions** (see appendix C) and two [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) occupy this room. Their revelry grants them disadvantage on Perception checks to detect the characters as they approach the chamber.
...
Twenty-five [sahuagin](Published/bestiary/humanoid/sahuagin.md), five [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and three [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) occupy this large common living quarters. Their weapons are close at hand.
...
The eggs are unhatched sahuagin. Disturbing the eggs in any way, including coming within 3 feet of them, causes dozens of them to break open. Three [sahuagin hatchling swarms](Published/bestiary/beast/sahuagin-hatchling-swarm-gos.md) (see appendix C) form and rush to attack warm-blooded characters. The sound of their offspring being threatened attracts the sahuagin in area 24, if they have not already been defeated.
...
Two [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) are conducting rites to Sekolah over the unhatched eggs. If the priestesses notice the party, they immediately awaken two [sahuagin hatchling swarms](Published/bestiary/beast/sahuagin-hatchling-swarm-gos.md) (see appendix C) from the eggs around them. The swarms attack the characters, while the priestesses try to flee, returning promptly with any surviving sahuagin from area 24.
...
A [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) prepares a squad of twelve [sahuagin](Published/bestiary/humanoid/sahuagin.md) and twelve [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) for patrol and guard duty. The sahuagin are armed and about to move out to relieve guards currently on active duty. They move to slay intruders the moment they notice them.

##### Development

The [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) in area 28 joins the battle in this area on the third round of combat.
...
A single [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) sits at the table, counting small stacks of gold coins.
...
A [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) prepares a squad of six [sahuagin](Published/bestiary/humanoid/sahuagin.md), six [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md), four [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md), and four [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) for patrol and guard duty (see appendix C for all but the [sahuagin](Published/bestiary/humanoid/sahuagin.md)). The sahuagin are armed and about to move out to relieve guards currently on duty. They treat intruders as hostile.

Four [sahuagin](Published/bestiary/humanoid/sahuagin.md) that are not part of the patrol are gambling on two lobsters fighting in a small net arena.

##### Development

The [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 30 joins the battle, arriving on the third round of combat.
...
A single [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) lies in a seaweed bed. It recently lost a large sum of gold to the sahuagin wave shaper in area 28.
...
The occupant of this room is currently in the temple assisting with the ceremony. The statuette is a [Sekolahian worshiping statuette](Published/items/sekolahian-worshiping-statuette-gos.md) (see appendix B).
...
A [sahuagin priestess](Published/bestiary/humanoid/sahuagin-priestess.md) is tending to the armored plates of four [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) in this room. She is startled to discover intruders have made it this far. She and the sharks attack all intruders.
...
Three [sahuagin priestesses](Published/bestiary/humanoid/sahuagin-priestess.md) are performing the ritual at the altar. Each sack contains ten sahuagin hatchlings that are no threat and are automatically slain if attacked. The [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) (see appendix C) swims menacingly overhead. The priestesses have disadvantage on any Perception checks to detect the characters. While the ritual is being maintained, the [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) does not attack the characters, even if it becomes aware of them. Interrupting the ritual, however, has dire consequences for everyone in the temple.
...
The ritual serves to placate and feed the [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md). It must be performed for another hour before it is considered complete. Every 10 minutes, one of the priestesses sacrifices a sahuagin hatchling, whose blood rises and feeds the avatar.
...
If the characters cause any of the three priestesses to stop chanting, the [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) descends and devours two of the priestesses immediately before attacking the party. The remaining priestess fights alongside the shark.

*Note*: The [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) and a single sahuagin priestess make for a hard fight for a party of four 7th-level characters. For each additional character in the party, allow one more priestess to survive to maintain the same degree of difficulty.
...
The two pearl-and-gold bands on the [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) are worth 125 gp each. One of the priestesses carries the key to the coffer in area 38.
...
Ten [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim through the water in this room. They are always hungry, and they attack creatures that enter the room other than sahuagin.
...
The sahuagin speaking to the baron is complaining about offensive remarks made by another sahuagin. The sahuagin wants the baron to punish the offender. The baron is growing impatient with the pettiness and is close to feeding all involved parties to the [Maw of Sekolah](Published/bestiary/npc/maw-of-sekolah-gos.md) in area 37.

Baron Kepmak ([sahuagin baron](Published/bestiary/humanoid/sahuagin-baron.md)) sits on his throne, while high priestess Thadrah ([sahuagin high priestess](Published/bestiary/humanoid/sahuagin-high-priestess-gos.md); see appendix C) stands at his side. The complainant is a [sahuagin](Published/bestiary/humanoid/sahuagin.md), while the two floating at attention are [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C). Two [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim high above the throne; they are the pets of the baron and defend him if he is attacked.
...
Baroness Seklaz ([sahuagin baron](Published/bestiary/humanoid/sahuagin-baron.md)) looms over her servant ([sahuagin](Published/bestiary/humanoid/sahuagin.md)), accusing it of stealing one of her earrings. The earring is, in fact, lost behind the throne in area 42, where the baroness dropped it days ago. A single [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) waits by the entryway. It was summoned to dispose of the servant and waits for the baroness's command to do so. If the characters enter combat with these three, the sahuagin servant slips away to find a nearby patrol (see "Patrols in the Lair") and returns with reinforcements in 5 rounds.
...
A [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) is preparing four [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) for patrol duty (see appendix C for both). A [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) watches the formation from near the foot of the stairs, and two [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md) are nearby (see appendix C for both). The group attacks the characters when they become aware of them.
...
Three [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) are torturing a [locathah](Published/bestiary/humanoid/locathah-gos.md) here (see appendix C for both). If the sahuagin become aware of the party, they abandon their work and attack.
...
A [sea lion](Published/bestiary/monstrosity/sea-lion-tftyp.md) (see appendix C) was captured by the sahuagin along with its triton master (see cell 50d) and is now being caged until a suitable opponent can be found to pit against it in the arena. If the triton is not with the characters when this door is opened, the sea lion attacks with extreme ferocity. If the triton is with the characters, he can calm and control the sea lion.
...
The figure is [Kysh](Published/bestiary/npc/kysh-gos.md) (see appendix C), who was captured by the sahuagin along with his sea lion companion (see cell 50b). He is being held until a suitable opponent can be found for him to fight in the arena. He has been stripped of his possessions.
...
[Kysh](Published/bestiary/npc/kysh-gos.md) was unconscious when he was brought into the fortress, so he has no idea of its layout, nor does he know what has happened to his sea lion companion.
...
Five [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) swim above the racks in this room. They have not been fed in some time and attack the characters on sight.
...
The sound of the slab being smashed rings through the nearby rooms, drawing the attention of the three [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 50, if they are still alive. They arrive 5 minutes later with twelve [sahuagin](Published/bestiary/humanoid/sahuagin.md) and two [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) (see appendix C) drawn from area 60.
...
On important occasions, more than two hundred sahuagin fill the arena to watch the sport, but at present fifty-five are here: forty-nine [sahuagin](Published/bestiary/humanoid/sahuagin.md), five [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md), and Blademaster Makaht ([sahuagin blademaster](Published/bestiary/humanoid/sahuagin-blademaster-gos.md), see appendix C), who sits apart from the rest in his special seat. The warriors and lieutenants are scattered around the area. All the sahuagin in the gallery have their usual weapons and equipment.
...
There are twenty off-duty [sahuagin](Published/bestiary/humanoid/sahuagin.md) here. They talk, check their equipment, sharpen their weapons, or simply swim lazily around. Most of their weapons have been laid aside, though within easy reach.
...
Noise of melee here will certainly be heard at the guard post (area 58), bringing two [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six [sahuagin](Published/bestiary/humanoid/sahuagin.md) to this area to investigate 3 rounds later. The two [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) in area 55 also hear the combat and arrive on the round after it starts.
...
Two [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) talk idly. The other two who bunk here are at the arena (area 53).
...
Though originally built to house more than twenty sahuagin, this area has recently been reserved for the sahuagin wave shapers. Currently, two [sahuagin wave shapers](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C), six [sahuagin](Published/bestiary/humanoid/sahuagin.md), and two [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) occupy this area.
...
One [sahuagin wave shaper](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C) magically assembles and disassembles the salt on the table.
...
Two [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and six [sahuagin](Published/bestiary/humanoid/sahuagin.md) keep watch in this area.
...
Most of the guards stationed here have slipped away to watch the fight in area 53. A [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) and one [sahuagin](Published/bestiary/humanoid/sahuagin.md) are left behind.
...
The occupants include forty-five [sahuagin](Published/bestiary/humanoid/sahuagin.md), ten [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md), seven [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md), four [sahuagin deep divers](Published/bestiary/humanoid/sahuagin-deep-diver-gos.md), and two [sahuagin wave shapers](Published/bestiary/humanoid/sahuagin-wave-shaper-gos.md) (see appendix C for all but the [sahuagin](Published/bestiary/humanoid/sahuagin.md)). The sahuagin in this area are socializing, performing drills, or resting in the seaweed beds. Six [shell sharks](Published/bestiary/monstrosity/shell-shark-gos.md) (see appendix C) also swim in the cavern, close to the roof of the natural area to the south. Shoals of tiny silver fish dart about here and there, obstructing vision in places.
...
| Area | Defenders |
|------|-----------|
| 1–4 | `2d6` [sahuagin](Published/bestiary/humanoid/sahuagin.md) |
| 5–11 | `3d6` [sahuagin](Published/bestiary/humanoid/sahuagin.md) and 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md)* |
| 12–18 | `3d6` [sahuagin](Published/bestiary/humanoid/sahuagin.md), 2 [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md)*, and 1 [sahuagin coral smasher](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md)* |
^sahuagin-defenders
...
**Reinforcements**. As soon as the fortress goes on alert, sahuagin reinforcements begin roaming the halls. These reinforcements only appear once the characters have already engaged with an area's defenders. Every `2d4` rounds after combat begins in an area, `3d6` [sahuagin](Published/bestiary/humanoid/sahuagin.md) and 1 [sahuagin champion](Published/bestiary/humanoid/sahuagin-champion-gos.md) (see appendix C) arrive. If the PCs manage to defeat all the sahuagin in a room (plus reinforcements) no further defenders appear.
...
However the party gains access to the fortress, they find the north entrance under heavy guard. A sizable force of ten [sahuagin](Published/bestiary/humanoid/sahuagin.md), two [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md), and two [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) hold ranks here, prepared to face whatever attack might come. Any conflict here that lasts for more than 5 rounds puts the entire fortress on alert.
...
The sahuagin are using these barracks as a forward command post. Thirty [sahuagin](Published/bestiary/humanoid/sahuagin.md), three [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md), five [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md), and Blademaster Makaht ([sahuagin blademaster](Published/bestiary/humanoid/sahuagin-blademaster-gos.md), see appendix C), if he survived, are now stationed here.
...
The sahuagin mount a desperate defense here, determined to protect their leaders below. An elite force of six [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) and four [sahuagin coral smashers](Published/bestiary/humanoid/sahuagin-coral-smasher-gos.md) maintain a guard post here.
...
Incensed by his forces' slaughter, Baron Kepmak, leader of the sahuagin forces, takes the field. This is your chance to add a dramatic finale to the assault, as the baron leads eight [sahuagin champions](Published/bestiary/humanoid/sahuagin-champion-gos.md) into battle. The baron roars as he launches into battle, attacking the largest character and cursing them in Sahuagin (calling them ichor-less tide pool dwellers and the like).
