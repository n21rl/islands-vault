...
Eda (CG female human [noble](Published/bestiary/humanoid/noble.md)) is the current senior member of the town council, as well as the owner of three large fishing boats. She has lived in Saltmarsh all her life and has been elected to the council three times. She is a gruff, pragmatic woman whose graying hair is cut short and whose face bears the marks of a life lived outdoors. Eda is keenly interested in expanding Saltmarsh's fishing industry, her sights set on a wild section of the coast where she hopes to build a new dock. She is suspicious of the dwarves' mining enterprise and doubts it will amount to much.
...
The leader of the newly established mining operation in Saltmarsh is an iron-willed dwarven woman named Manistrad (LN female dwarf [veteran](Published/bestiary/humanoid/veteran.md)). She runs the mining outfit from a small office near the edge of town. Manistrad is a competent leader, as well as a savvy miner with a knack for pulling off impossible jobs. She's convinced that the veins of silver found in the cliffs near Saltmarsh are indicative of more valuable stones deeper in the rock. She was once a fearsome warrior, and she's not above delivering a few well-placed blows to ensure her orders are followed.
...
Young Anders (LG male human [noble](Published/bestiary/humanoid/noble.md)) recently inherited his family's fleet of fishing boats after the untimely death of his mother, Petra. He's the youngest person ever to be elected to the council. Brash and inexperienced, Anders is a slight man with sharp features and a toothy smile. His recent forays into trade have made him a local celebrity. Since Anders owns both a fishing fleet and several trading vessels, he can sell his catch at a highly competitive price. And he can offer better prices for the other fishers in town to sell to him, since his catch brings in so much more profit.
...
Skerrin (LE male human [assassin](Published/bestiary/humanoid/assassin.md)) is secretly the head Brotherhood agent in town. Tall, lean, tan, with short silver hair, he speaks in precise, measured statements of a man who has a keen eye for detail. He is dispassionate and takes a protective stance toward Anders. To observers, he is nothing more than a faithful and trusted butler.
...
Built on a low hill, the Saltmarsh barracks are also its jail. It is one of the few structures in Saltmarsh with an underground level. The jailer, Kraddok Stonehorn (LG male human [gladiator](Published/bestiary/humanoid/gladiator.md)), is an old comrade of Eliander. He is a stickler for the rules, and Eliander trusts him with his life.
...
Rumors abound of a vault hidden beneath the building. In the cellar, the dwarves have dug a chamber in the earth that is sealed with a heavy iron door and a fine lock (requiring a successful DC 25 Dexterity check with thieves' tools to pick). The dwarves keep their funds here—about 1,000 gp in coins and gems, guarded by four suits of [animated armor](Published/bestiary/construct/animated-armor.md) and a [rug of smothering](Published/bestiary/construct/rug-of-smothering.md) left in the vault. The constructs do not attack dwarves and can be disabled for 10 minutes if the command word "Tatalot" is spoken to them. Manistrad and her close advisors know the command word.

#### 6. Keledek Tower

This three-story tower is home to the town's resident sage and wizard, Keledek the Unspoken (LE male human [mage](Published/bestiary/humanoid/mage.md)). Keledek's dusky skin, bald head, and bright red silk turban—not to mention his height of nearly 7 feet—make him an unmistakable figure in town.

Keledek came to town years ago from Ket, a distant kingdom held in a mix of contempt, mistrust, and fear by the locals. Rumor around town claims that speaking his name aloud allows Keledek to eavesdrop on a conversation for a short time. In truth, Keledek relies on his familiar, an [imp](Published/bestiary/fiend/imp-xphb.md) named Zivmal, to spy on the townsfolk.
...
The Snapping Line is run by a young woman named Hanna Rist (NG female human [commoner](Published/bestiary/humanoid/commoner.md)), who comes from a family of well-known lobster catchers. The Rist family also makes a spirit from lobster meat and potatoes called claw wine; it is, to put it mildly, an acquired taste. Hanna employs several former dockhands to keep peace in her bar.
...
The blacksmith's forge has a single anvil with a clear sign of dwarven origins, and a backlog of orders ten miles long. The human smiths make hooks, nails, harpoons, knives, fishing weights, and much more all day. Their master smith is an elderly, dark-skinned woman named Mafera (LG female human [commoner](Published/bestiary/humanoid/commoner.md)); her son, Jasker (LG male human [commoner](Published/bestiary/humanoid/commoner.md)), is her best journeyman. A small shrine to Moradin can be found under the eaves as well, though it is somewhat neglected.
...
The Solmor family maintains a cadre of a dozen [guards](Published/bestiary/humanoid/guard.md) led by four [veterans](Published/bestiary/humanoid/veteran.md) (all LE humans). These mercenaries report to Skerrin, and though they outwardly serve the Solmors, their loyalty is to the Scarlet Brotherhood.
...
Services at this long-standing sea god's temple are well attended. The congregation is led by a one-legged former whaler: Wellgar Brinehanded (CG male human [priest](Published/bestiary/humanoid/priest.md)), an older human man with a sharp memory for every storm, lost ship, and enormous catch ever brought into Saltmarsh harbor. He knows many fanciful stories of shipwrecks, lucky escapes, and famous captains. Matters ashore rarely interest him, but the temple and its bell tower are also served by a half-dozen novitiates and laypeople who keep things running smoothly.
...
[Captain Xendros](Published/bestiary/npc/captain-xendros-gos.md) of the Faithful Quartermasters of Iuz has magic items for sale and can also broker the sale of magic items. Any such item comes with a mild curse, however. Anyone attuned to the item can be targeted by a detect thoughts spell cast by Xendros, with no limit on range; any saving throws triggered by the spell automatically fail; and the target has no knowledge of the casting. This curse can be detected by casting an identify spell on the item and succeeding on a DC 25 Intelligence (Arcana) check. The check can be attempted once per casting.
...
This lair is an underwater stronghold maintained by the sahuagin. From here, they prey on passing ships and plot to grow in strength to the point that they can lay waste to Saltmarsh. A total of thirty [sahuagin](Published/bestiary/humanoid/sahuagin.md), a [sahuagin priestess](Published/bestiary/humanoid/sahuagin-priestess.md), and a [sahuagin baron](Published/bestiary/humanoid/sahuagin-baron.md) lair here.
...
Since then, the ruins have been largely forgotten. The exception is Keledek the Unspoken, the town wizard, who used magic to open the cellar door and found that the passages led to a hidden sea cave. He uses the cave as a meeting point for smugglers. He has recruited several [goblins](Published/bestiary/humanoid/goblin.md) to keep watch over the place, along with a trained [giant constrictor snake](Published/bestiary/beast/giant-constrictor-snake.md) he raised from a hatchling. The goblins barricaded several passages leading deeper into the dungeons after losing several of their number to [ghouls](Published/bestiary/undead/ghoul.md) and [giant rats](Published/bestiary/beast/giant-rat.md) that emerged from the depths.
...
One of the Dreadwood's most powerful denizens is a truly ancient [night hag](Published/bestiary/fiend/night-hag.md) named Granny Nightshade, who dwells in the deepest depths of the forest. She commands magic as well as a mighty wizard does and has struck bargains with several dukes of the Nine Hells. Her twisted fortress, Castle Spiral, stands at the nexus point between the Shadowfell and Oerth, and from its gates emerge [skeletons](Published/bestiary/undead/skeleton-xphb.md), [zombies](Published/bestiary/undead/zombie-xphb.md), [shadows](Published/bestiary/undead/shadow.md), and other horrors to threaten the land.

Granny Nightshade counts [jackalweres](Published/bestiary/humanoid/jackalwere.md) as her foremost minions, and she has also acquired the services of [goblins](Published/bestiary/humanoid/goblin.md), [orcs](Published/bestiary/humanoid/orc.md), [hobgoblins](Published/bestiary/humanoid/hobgoblin.md), [ogres](Published/bestiary/giant/ogre.md), and [trolls](Published/bestiary/giant/troll.md) over the years. [Green hags](Published/bestiary/fey/green-hag.md) bound to her service act as baronesses who enforce her will over their section of the forest, and an elite guard of twenty-three [oni](Published/bestiary/giant/oni.md) acts as her personal messengers and enforcers. She keeps three consorts, powerful [vampires](Published/bestiary/undead/vampire.md) that struggle among themselves for her favor.

##### Outer Fringe

The outermost reaches of the Dreadwood are as lightly wooded as those of any other forest and extend five to ten miles into the woods. This part of the forest is as safe as any other woodland, thanks to frequent ranger and elf patrols that keep the denizens of the deeper forest at bay if they try to encroach here. [Owlbears](Published/bestiary/monstrosity/owlbear.md), [wolves](Published/bestiary/beast/wolf-xphb.md), and a few [bandit](Published/bestiary/humanoid/bandit.md) gangs that elude the notice of the patrols represent the most common threats to explorers or travelers.
...
|-----------|--------------|----------------|---------------|
| 1–3 | `2d6` [goblins](Published/bestiary/humanoid/goblin.md) | `2d6` [skeletons](Published/bestiary/undead/skeleton-xphb.md) | `4d6` [skeletons](Published/bestiary/undead/skeleton-xphb.md) |
| 4–5 | `2d6` elf [veterans](Published/bestiary/humanoid/veteran.md) | `1d10` [zombies](Published/bestiary/undead/zombie-xphb.md) | `3d10` [zombies](Published/bestiary/undead/zombie-xphb.md) |
| 6–7 | `3d6` [bandits](Published/bestiary/humanoid/bandit.md) | `2d6` [hobgoblins](Published/bestiary/humanoid/hobgoblin.md) | `3d4` [ghouls](Published/bestiary/undead/ghoul.md) |
| 8–9 | `2d4` [jackalweres](Published/bestiary/humanoid/jackalwere.md) | `1d6` [bugbears](Published/bestiary/humanoid/bugbear.md) | `2d6` [specters](Published/bestiary/undead/specter.md) |
| 10 | `3d6` [stirges](Published/bestiary/beast/stirge.md) | `2d4` [ghouls](Published/bestiary/undead/ghoul.md) | `2d4` [wights](Published/bestiary/undead/wight.md) |
| 11 | `1d3` [vine blights](Published/bestiary/plant/vine-blight.md) | `1d6` [specters](Published/bestiary/undead/specter.md) | `1d6` [vampire spawn](Published/bestiary/undead/vampire-spawn.md) |
| 12 | `2d4` [hobgoblins](Published/bestiary/humanoid/hobgoblin.md) | `1d4` [green hags](Published/bestiary/fey/green-hag.md) | `1d6` [wraiths](Published/bestiary/undead/wraith.md) |
| 13 | `1d3` [dire wolves](Published/bestiary/beast/dire-wolf-xphb.md) | 1 [banshee](Published/bestiary/undead/banshee.md) | `2d6` [mummies](Published/bestiary/undead/mummy.md) |
| 14 | `1d4` [green hags](Published/bestiary/fey/green-hag.md) | 1 [night hag](Published/bestiary/fiend/night-hag.md) | `2d4 + 2` [shadows](Published/bestiary/undead/shadow.md) |
| 15 | `1d3` [treants](Published/bestiary/plant/treant.md) | 1 [lamia](Published/bestiary/monstrosity/lamia.md) | `1d3` [vampires](Published/bestiary/undead/vampire.md) |
| 16 | `2d4` [kobolds](Published/bestiary/humanoid/kobold.md) | `1d3` [wraiths](Published/bestiary/undead/wraith.md) | `1d3` [night hags](Published/bestiary/fiend/night-hag.md) |
| 17 | 1 [unicorn](Published/bestiary/celestial/unicorn.md) | `1d3` [gorgons](Published/bestiary/monstrosity/gorgon.md) | `2d4` [shambling mounds](Published/bestiary/plant/shambling-mound.md) |
| 18 | 1 [troll](Published/bestiary/giant/troll.md) | `1d3` [mummies](Published/bestiary/undead/mummy.md) | `1d4` [oni](Published/bestiary/giant/oni.md) |
| 19 | `2d6` [hobgoblins](Published/bestiary/humanoid/hobgoblin.md) | `1d4 + 1` [shadows](Published/bestiary/undead/shadow.md) | 1 [adult green dragon](Published/bestiary/dragon/adult-green-dragon.md) |
| 20 | `1d3` [ogres](Published/bestiary/giant/ogre.md) | 1 [vampire](Published/bestiary/undead/vampire.md) | 1 [death knight](Published/bestiary/undead/death-knight.md) |
^dreadwood-random-encounters

#### Drowned Forest

Perched at the edge of the Hool Marshes, the Drowned Forest was once a verdant region. A few decades ago, the marsh began to encroach on this area. As the water level rose, the forest was transformed into a more foreboding place. [Shambling mounds](Published/bestiary/plant/shambling-mound.md) and **blights** appeared in the forest in increasing numbers while the water rotted away the trees themselves. In time, strange mushrooms and fungus sprouted throughout the woods.
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | A human [zombie](Published/bestiary/undead/zombie-xphb.md) is chained to a wooden stake driven into the ground. The remains of many other zombies lie nearby. A successful DC 10 Intelligence (Investigation) or Wisdom (Survival) check reveals evidence that the zombie is being used as target practice. |
...
| 7 | An abandoned carriage is home to a [black pudding](Published/bestiary/ooze/black-pudding.md). A variety of fancy but acid-scorched clothing lies gummed within the cab. |
| 8 | An intact [sailing ship](Published/vehicles/sailing-ship.md) sits in the branches of a low-growing grove of trees. The branches move in the wind and emulate the motion of the sea. |
| 9 | A 40-foot-tall sculpture of a toad made from animal waste emits a foul smell discernible from up to a mile away. Five [swarms of insects](Published/bestiary/beast/swarm-of-insects.md) gather around it. |
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–3 | `1d4` [awakened trees](Published/bestiary/plant/awakened-tree.md) |
| 4–5 | `2d6` [zombies](Published/bestiary/undead/zombie-xphb.md) |
| 6–7 | `1d3` [shambling mounds](Published/bestiary/plant/shambling-mound.md) |
| 8–9 | `2d4` [myconid adults](Published/bestiary/plant/myconid-adult.md) and 1 [myconid sovereign](Published/bestiary/plant/myconid-sovereign.md) |
| 10 | `3d6` [stirges](Published/bestiary/beast/stirge.md) |
| 11 | `1d3` [trolls](Published/bestiary/giant/troll.md) |
| 12 | `2d4` [gnolls](Published/bestiary/humanoid/gnoll.md) and 1 [gnoll pack lord](Published/bestiary/humanoid/gnoll-pack-lord.md) |
| 13 | 1 [water elemental](Published/bestiary/elemental/water-elemental.md) |
| 14 | 1 [vrock](Published/bestiary/fiend/vrock.md) |
| 15 | `2d6` [manes](Published/bestiary/fiend/manes.md) |
| 16 | `2d4` [dretches](Published/bestiary/fiend/dretch.md) |
| 17 | `1d8` [bullywugs](Published/bestiary/humanoid/bullywug.md) |
| 18 | `1d4` [vine blights](Published/bestiary/plant/vine-blight.md) |
| 19 | `2d8` [twig blights](Published/bestiary/plant/twig-blight.md) |
| 20 | `2d4` [needle blights](Published/bestiary/plant/needle-blight.md) |
^drowned-forest-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d10` [bullywugs](Published/bestiary/humanoid/bullywug.md) |
| 4–5 | `2d6` [bandits](Published/bestiary/humanoid/bandit.md) |
| 6–7 | `2d4` [vine blights](Published/bestiary/plant/vine-blight.md) with `1d6` [needle blights](Published/bestiary/plant/needle-blight.md) |
| 8–9 | `1d4` [poisonous snakes](Published/bestiary/beast/venomous-snake-xphb.md) |
| 10 | `3d6` [rats](Published/bestiary/beast/rat-xphb.md) |
| 11 | `1d6` [giant toads](Published/bestiary/beast/giant-toad.md) |
| 12 | `1d4` [crocodiles](Published/bestiary/beast/crocodile-xphb.md) |
| 13 | `2d6` [kobolds](Published/bestiary/humanoid/kobold.md) |
| 14 | `2d6` [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) |
| 15 | 1 [hydra](Published/bestiary/monstrosity/hydra.md) |
| 16 | 1 [shambling mound](Published/bestiary/plant/shambling-mound.md) |
| 17 | 1 [green hag](Published/bestiary/fey/green-hag.md) and `1d3` [will-o'-wisps](Published/bestiary/undead/will-o-wisp.md) |
| 18 | `1d3` [trolls](Published/bestiary/giant/troll.md) |
| 19 | `1d4` [ochre jellies](Published/bestiary/ooze/ochre-jelly.md) |
| 20 | 1 [young black dragon](Published/bestiary/dragon/young-black-dragon.md) |
^hool-marshes-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d6` [bandits](Published/bestiary/humanoid/bandit.md) |
| 4 | `1d4` [gray oozes](Published/bestiary/ooze/gray-ooze.md) |
| 5 | `1d6` [ogres](Published/bestiary/giant/ogre.md) |
| 6–7 | `1d3` [crocodiles](Published/bestiary/beast/crocodile-xphb.md) |
| 8–10 | `2d6` [bullywugs](Published/bestiary/humanoid/bullywug.md) |
| 11–12 | 1 [black pudding](Published/bestiary/ooze/black-pudding.md) |
| 13 | 1 [gelatinous cube](Published/bestiary/ooze/gelatinous-cube.md) |
| 14–15 | `2d4` [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) |
| 16 | 1 [shambling mound](Published/bestiary/plant/shambling-mound.md) |
| 17–19 | `1d3` [ochre jellies](Published/bestiary/ooze/ochre-jelly.md) |
| 20 | 1 [young black dragon](Published/bestiary/dragon/young-black-dragon.md) |
^dunwater-river-random-encounters
...
Located in just 15 feet of water, this small fishing boat is named for the exquisite, silvered fishing pole its prior owner once possessed. The fishing pole, worth 200 gp, rests with the wreck. Unfortunately for treasure seekers, a [giant crab](Published/bestiary/beast/giant-crab-xphb.md) makes its lair in the boat's remains.

##### Escape

This [sailing ship](Published/vehicles/sailing-ship.md) was a renowned blockade runner before it was run down and destroyed by ships of the Sea Princes. Its wreckage is scattered at a depth of 30 feet. A waterproofed treasure chest inside the broken hull bears the lion rampant emblem of Keoland and holds 500 gp. Two [swarms of quippers](Published/bestiary/beast/swarm-of-quippers.md) prowl the area in search of a meal.

##### Curiosity

This galleon belonged to the mage Mordenkainen, who dispatched it to a distant shore in search of treasure. The ship sank in a mysterious and especially ferocious storm. A convincingly crab-like apparatus of Kwalish being transported in its hold remains at the sea bottom, but a [marilith](Published/bestiary/fiend/marilith.md) bound to guard it remains and attempts to slay anyone other than Mordenkainen who lays a hand on it. The ship sits approximately 100 feet below the waves.
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d6` [blood hawks](Published/bestiary/beast/blood-hawk.md) |
| 4 | `2d6` [stirges](Published/bestiary/beast/stirge.md) |
| 5 | `1d6` [giant crabs](Published/bestiary/beast/giant-crab-xphb.md) |
| 6–7 | `1d3` [perytons](Published/bestiary/monstrosity/peryton.md) |
| 8–10 | `1d3` [giant lizards](Published/bestiary/beast/giant-lizard.md) |
| 11–12 | `2d8` [giant rats](Published/bestiary/beast/giant-rat.md) |
| 13 | `2d6` [sahuagin](Published/bestiary/humanoid/sahuagin.md) |
| 14–15 | `2d4` [lizardfolk](Published/bestiary/humanoid/lizardfolk.md) |
| 16 | `1d3` [merrow](Published/bestiary/monstrosity/merrow.md) |
| 17–19 | 1 [cyclops](Published/bestiary/giant/cyclops.md) |
| 20 | `1d3` [chuuls](Published/bestiary/aberration/chuul.md) |
^coast-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–2 | `1d3` [giant octopi](Published/bestiary/beast/giant-octopus.md) |
| 3–4 | 1 [plesiosaurus](Published/bestiary/beast/plesiosaurus.md) |
| 5–6 | `1d3` [perytons](Published/bestiary/monstrosity/peryton.md) |
| 7 | `1d3` [water elementals](Published/bestiary/elemental/water-elemental.md) |
| 8–10 | `2d4` [reef sharks](Published/bestiary/beast/reef-shark-xphb.md) |
| 11–12 | `2d8` [sahuagin](Published/bestiary/humanoid/sahuagin.md) |
| 13 | `1d4+1` [merrow](Published/bestiary/monstrosity/merrow.md) |
| 14–15 | `2d6` [pteranodons](Published/bestiary/beast/pteranodon.md) |
| 16 | 1 [adult bronze dragon](Published/bestiary/dragon/adult-bronze-dragon.md) |
| 17 | Pirate ship, [Gnasher](Published/vehicles/warship.md) |
| 18 | Pirate ship, [Pale Prow](Published/vehicles/warship.md) |
| 19 | Pirate ship, *Salted Glade* |
| 20 | Pirate ship, [Dreadnaught](Published/vehicles/warship.md) |
^azure-sea-random-encounters

#### Gnasher

Thereax Guldeer (LE [half-red dragon veteran](Published/bestiary/humanoid/half-red-dragon-veteran.md)) took command of the [warship](Published/vehicles/warship.md), [Gnasher](Published/vehicles/warship.md), several years ago when her father was slain in a duel with an admiral in the Keoland Navy. The young half-dragon is merciless, and her greed is as strong as that of any red dragon. She alone can sound the dragon's horn, a monstrous instrument mounted to the prow of her ship. When blown, it roars like a massive dragon.

[Gnasher](Published/vehicles/warship.md) is crewed by uncouth humanoids who fear and admire Thereax, amounting to twenty-three [orcs](Published/bestiary/humanoid/orc.md), forty [goblins](Published/bestiary/humanoid/goblin.md), four [hobgoblins](Published/bestiary/humanoid/hobgoblin.md), twelve [kobolds](Published/bestiary/humanoid/kobold.md), and two [bugbears](Published/bestiary/humanoid/bugbear.md). An [ogre](Published/bestiary/giant/ogre.md) named Yem serves as the ship's first mate, and Yem's method of discipline tends to be fatal. A red dragon's wing emblazoned on a black background flies from the mast of [Gnasher](Published/vehicles/warship.md).

#### Pale Prow

An old ship whose faded hull and rat-gnawed sails belie its speed and the ferocity of its crew, [Pale Prow](Published/vehicles/warship.md) is a ramshackle [warship](Published/vehicles/warship.md) with an ornate rudder made from bone and wood. The rudder is not attached to the ship's wheel and is instead operated by a team of six [vampire spawn](Published/bestiary/undead/vampire-spawn.md), who turn it at the command of its dread captain. [Pale Prow](Published/vehicles/warship.md) doesn't sail under the sun, and its appearance is always preceded by a heavy fog that appears without warning. It is said that [Pale Prow](Published/vehicles/warship.md) has never been touched by a shipwright, despite its many injuries. By what means the ship is repaired, none can say.

[Pale Prow](Published/vehicles/warship.md) is commanded by Captain Ineca Sufocan (LE male elf [vampire](Published/bestiary/undead/vampire.md)), who sails from an island hidden by fog, where his harbor and mansion have fallen into disrepair. Ineca searches for a heart made of pearl, which contains drops of dried blood from his true love. This pearl heart has exchanged hands for decades, and the undead captain desires it above all things.

The remainder of the crew of [Pale Prow](Published/vehicles/warship.md) is composed of undead servants, both corporeal and ghostly. Necromancers are drawn to [Pale Prow](Published/vehicles/warship.md) whenever it nears land, and it is common for them to take up residence in the dark cabins below deck. A [specter](Published/bestiary/undead/specter.md) serves as lookout in the crow's nest.

A silver skull embroidered on a white field and trimmed with silver fangs flies from the tall mast of [Pale Prow](Published/vehicles/warship.md).

#### Salted Glade

The Salted Glade is a galleon made from the base of a massive, buoyant tree. A grove of smaller trees grows from its deck, their boughs catching the winds to propel the ship. From a distance, the two [treants](Published/bestiary/plant/treant.md) who serve as the ship's main artillery are visible moving on deck.

The Salted Glade is captained by Mithina Greyheart (NE halfelf female [druid](Published/bestiary/humanoid/druid.md)), whose grove was destroyed by a massive tidal wave nearly twenty years ago. Mithina's heart sank with her grove, and her mind turned to vengeance. She has since turned to piracy to fund her search for a legendary island known as Procan's Bloom, where she hopes to chastise the god Ehlonna for the destruction of her home. Aiding her is the corrupted [dryad](Published/bestiary/fey/dryad.md) Filios, who dwells in a shriveled oak growing from the ship's center.

A black leafless branch stitched on a field of blue flaps from the highest boughs of the Salted Glade.

#### Dreadnaught

[Dreadnaught](Published/vehicles/warship.md) is a heavy [warship](Published/vehicles/warship.md) covered in scorched iron plates laid over coal-colored wood. No portholes or oar slits mar the perfect surface of its riveted hull; no mast can be seen to rise from its sooty deck. A cabin, reinforced with steel bars, sits toward the aft, a dull red glow pulsing from within.

[Dreadnaught's](Published/vehicles/warship.md) captain is a mad tinkerer and wizard named Vigr Thrass (CE male human [mage](Published/bestiary/humanoid/mage.md)). Vigr's madness arose from his discovery of a dark tome that described rituals used to animate constructs. The wizard now sails the Azure Sea, stealing wealth and arms from merchant and navy vessels alike. Vigr wears a suit of magic plate armor, granting him supernatural strength and speed while allowing him to cast his spells unhindered. He is known to mingle in the seaside communities, where he pretends to be a kind-hearted merchant in need of a few crew members. In reality, the captain is looking for suitable slaves to clean and repair his magic automatons.

[Dreadnaught's](Published/vehicles/warship.md) crew includes twelve automatons ([animated armor](Published/bestiary/construct/animated-armor.md)) brought to life by Vigr's magic. Various tools, weapons, and implements ([flying swords](Published/bestiary/construct/flying-sword.md)) flit about the ship performing tasks. A dozen humanoid slaves are kept aboard to accomplish the tasks Vigr's automatons cannot perform.
...
See the [fisher](Published/backgrounds/fisher-gos.md) entry for the full description of this background.
...
See the [marine](Published/backgrounds/marine-gos.md) entry for the full description of this background.
...
See the [shipwright](Published/backgrounds/shipwright-gos.md) entry for the full description of this background.
...
See the [smuggler](Published/backgrounds/smuggler-gos.md) entry for the full description of this background.
