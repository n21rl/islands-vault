...
![Levels 1–4: Local Heroes; Levels 1–4 Adventure Situations](Published/tables/levels-14-local-heroes-levels-14-adventure-situations-xdmg.md)
...
![Levels 5–10: Heroes of the Realm; Levels 5–10 Adventure Situations](Published/tables/levels-510-heroes-of-the-realm-levels-510-adventure-situations-xdmg.md)
...
![Levels 11–16: Masters of the Realm; Levels 11–16 Adventure Situations](Published/tables/levels-1116-masters-of-the-realm-levels-1116-adventure-situations-xdmg.md)
...
![Levels 17–20: Masters of the World; Levels 17–20 Adventure Situations](Published/tables/levels-1720-masters-of-the-world-levels-1720-adventure-situations-xdmg.md)
...
![Adventure Patrons; Patron Hooks](Published/tables/adventure-patrons-patron-hooks-xdmg.md)
...
![Supernatural Hooks](Published/tables/supernatural-hooks-xdmg.md)
...
![Happenstance Hooks](Published/tables/happenstance-hooks-xdmg.md)
...
- **The DM's Role.** If the characters can't figure out how to solve an encounter or aren't sure what to do next, you can remind the players of things their characters have already learned or call for Intelligence ([Investigation](Published/rules/skills.md#Investigation)) or similar checks to see if their characters can remember and connect things that the players might be missing.  
...
![Determine Your XP Budget; XP Budget per Character](Published/tables/determine-your-xp-budget-xp-budget-per-character-xdmg.md)
...
- 1 Wight (700 XP), 1 Warhorse Skeleton (100 XP), and 6 [Skeletons](Published/bestiary/undead/skeleton-xphb.md) (50 XP each), for 1,100 XP total  
...
A published adventure typically notes or implies whether a creature's initial attitude toward the adventurers is [Friendly [Attitude]](Published/rules/variant-rules/friendly-attitude-xphb.md), [Indifferent [Attitude]](Published/rules/variant-rules/indifferent-attitude-xphb.md), or [Hostile [Attitude]](Published/rules/variant-rules/hostile-attitude-xphb.md). In an encounter you've created, you can decide that starting attitude, or you can randomly determine it using the Initial Attitude table.

![Initial Attitudes; Initial Attitude](Published/tables/initial-attitudes-initial-attitude-xdmg.md)
...
![Monster Personality](Published/tables/monster-personality-xdmg.md)
...
![Monster Relationships](Published/tables/monster-relationships-xdmg.md)
...
![Bring It to an End; Adventure Climax](Published/tables/bring-it-to-an-end-adventure-climax-xdmg.md)
...
![Random Individual Treasure](Published/tables/random-individual-treasure-xdmg.md)
...
![Treasure Hoards; Random Treasure Hoard](Published/tables/treasure-hoards-random-treasure-hoard-xdmg.md)
...
As they leave the wood, the characters encounter Borogrove again. If they used his acorn, he gives them another one. If they purified the source of the stream, he gives them a [Staff of Flowers](Published/items/staff-of-flowers-xdmg.md) in gratitude.
...
![Exploring the Mine](Published/tables/exploring-the-mine-xdmg.md)
...
- Two [Spell Scrolls](Published/items/spell-scroll-xdmg.md) ([Alarm](Published/spells/alarm-xphb.md) and [Comprehend Languages](Published/spells/comprehend-languages-xphb.md))  
...
Melchis hires a ship to carry the party to the Amedio Jungle. Use the map to determine how long the sea voyage takes, depending on where the adventurers begin the trip and figuring that the ship covers about 1½ hexes per day. Near the end of the trip, as the ship crosses Jeklea Bay, it's attacked by a group of [Hostile [Attitude]](Published/rules/variant-rules/hostile-attitude-xphb.md) sahuagin, including two Sahuagin Priests, six Sahuagin Warriors, and a Water Elemental. (Assume the ship's crew stays out of the way of these terrifying monsters and lets the characters and Melchis deal with this threat.) Stage 1 ends when Melchis and the characters row a launch ashore.
...
![Stage 2](Published/tables/stage-2-xdmg.md)
...
The Horns of the Beast—a jagged crown made from the horns of demons and wild animals—rests on a pedestal in the northwest corner of the ruins. Melchis immediately attempts to seize the Artifact and place it on his head. If he does, he is transformed into a Hezrou and tries to kill the characters. A character who dons the Artifact is cursed with "Demonic Possession" (see ""Curses and Magical Contagions"" in "chapter 3"). The Artifact can't be removed from the character's head until a [Remove Curse](Published/spells/remove-curse-xphb.md) spell is cast on the character. If the characters defeat Melchis and search him, they find a [Bag of Holding](Published/items/bag-of-holding-xdmg.md) containing twelve 5-pound gold trade bars (worth 250 GP each) and a [Spell Scroll](Published/items/spell-scroll-xdmg.md) of [Teleportation Circle](Published/spells/teleportation-circle-xphb.md). The scroll also contains the sigil sequence for a permanent teleportation circle. At the end of the adventure, each character earns a bonus 1,000 XP.

##### Destroying the Artifact

The Horns of the Beast can be destroyed only by dropping it in the "River Oceanus", which flows through the Upper Planes (see "chapter 6"). A character can learn this by casting [Identify](Published/spells/identify-xphb.md) on the Artifact.
...
- Cannifer is a Satyr Revelmaster who is used to being the center of attention at every ball he attends and is thus [Hostile [Attitude]](Published/rules/variant-rules/hostile-attitude-xphb.md) to the adventurers.  
- Darisis a [Friendly [Attitude]](Published/rules/variant-rules/friendly-attitude-xphb.md), fun-loving Dryad who wants to be seen dancing with all the adventurers.  
- Fidget is a playful Pixie who is [Indifferent [Attitude]](Published/rules/variant-rules/indifferent-attitude-xphb.md) and pesters the adventurers with pranks throughout the evening, without causing any actual harm.  
- Granny Snailtongue is a [Hostile [Attitude]](Published/rules/variant-rules/hostile-attitude-xphb.md) Green Hag who sees the adventurers as potentially useful tools. She offers to help them at every turn in hopes of putting them in her debt.  
- Raxas Albrethin is an arrogant, Chaotic Neutral drow Mage who is initially [Hostile [Attitude]](Published/rules/variant-rules/hostile-attitude-xphb.md) and wants to see the adventurers humiliated. However, once the characters' Renown Score reaches 6, Raxas admits he misjudged them and becomes [Friendly [Attitude]](Published/rules/variant-rules/friendly-attitude-xphb.md).  
