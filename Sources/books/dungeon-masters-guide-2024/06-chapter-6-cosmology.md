...
![Outer Planes](Published/tables/outer-planes-xdmg.md)
...
A number of spells allow direct or indirect access to different planes of existence. [Gate](Published/spells/gate-xphb.md) and [Plane Shift](Published/spells/plane-shift-xphb.md) can directly transport adventurers to any other plane, with different degrees of precision. [Etherealness](Published/spells/etherealness-xphb.md) allows adventurers to enter the Ethereal Plane. And [Astral Projection](Published/spells/astral-projection-xphb.md) lets adventurers project themselves into the Astral Plane and from there travel to the Outer Planes.
...
![Planar Adventure Situations](Published/tables/planar-adventure-situations-xdmg.md)
...
![Layers of the Abyss](Published/tables/layers-of-the-abyss-xdmg.md)
...
![Layers of Acheron](Published/tables/layers-of-acheron-xdmg.md)
...
![Layers of Arborea](Published/tables/layers-of-arborea-xdmg.md)
...
![Layers of Arcadia](Published/tables/layers-of-arcadia-xdmg.md)
...
![Astral Color Pools](Published/tables/astral-color-pools-xdmg.md)
...
![Psychic Wind Location Effects](Published/tables/psychic-wind-location-effects-xdmg.md)
...
![Psychic Wind Psychic Effects](Published/tables/psychic-wind-psychic-effects-xdmg.md)
...
![Layers of Bytopia](Published/tables/layers-of-bytopia-xdmg.md)
...
![Layers of Carceri](Published/tables/layers-of-carceri-xdmg.md)
...
Built atop a tall basalt crag in the middle of a lava river is an iron-walled tavern that is most easily reached by hot-air balloon. The proprietor is a sentient [Flame Tongue (Mace)](Published/items/flame-tongue-xdmg.md) named Torchy, who sells a fine ale and seems to have a new wielder every few months. Torchy's is a popular hangout for ballooning enthusiasts.
...
![Layers of Elysium](Published/tables/layers-of-elysium-xdmg.md)
...
Characters can use the [Etherealness](Published/spells/etherealness-xphb.md) spell to enter the Border Ethereal. The [Plane Shift](Published/spells/plane-shift-xphb.md) spell allows transport to the Border Ethereal or the Deep Ethereal, but unless the intended destination is a specific location or a teleportation circle, the point of arrival could be anywhere on the plane.
...
![Deep Ethereal; Ethereal Curtains](Published/tables/deep-ethereal-ethereal-curtains-xdmg.md)
...
Whenever a creature or group of creatures leaves the Feywild after spending at least 1 day on that plane, you can choose a time change that works best for your campaign, if any, or roll on the Feywild Time Warp table. A [Wish](Published/spells/wish-xphb.md) spell can be used to remove the effect on up to ten creatures. Some powerful Fey have the ability to grant such wishes and might do so if the beneficiaries agree to subject themselves to a [Geas](Published/spells/geas-xphb.md) spell and complete a quest after the *Wish* spell is cast.

![Feywild Time Warp](Published/tables/feywild-time-warp-xdmg.md)
...
![Layers of Gehenna](Published/tables/layers-of-gehenna-xdmg.md)
...
![Layers of Mount Celestia](Published/tables/layers-of-mount-celestia-xdmg.md)
...
![Layers of the Nine Hells](Published/tables/layers-of-the-nine-hells-xdmg.md)
...
> -     - Lemure    
> -     - [Imp](Published/bestiary/fiend/imp-xphb.md)    
>         - Spined devil    
>         - Bearded devil    
>         - Barbed devil    
>         - Chain devil    
...
![Gate-Towns of the Outlands](Published/tables/gate-towns-of-the-outlands-xdmg.md)
...
![Layers of Pandemonium](Published/tables/layers-of-pandemonium-xdmg.md)
...
![Layers of Ysgard](Published/tables/layers-of-ysgard-xdmg.md)
