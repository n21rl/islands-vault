...
![Party Formation; Party Origin](Published/tables/party-formation-party-origin-tce.md)
...
- [Expert Sidekick](Published/classes/expert-sidekick-tce.md)  
- [Spellcaster Sidekick](Published/classes/spellcaster-sidekick-tce.md)  
- [Warrior Sidekick](Published/classes/warrior-sidekick-tce.md)  
...
![Monster Research](Published/tables/monster-research-tce.md)

### Monsters' Desires

![Monsters' Desires; Aberrations](Published/tables/monsters-desires-aberrations-tce.md)

![Monsters' Desires; Beasts](Published/tables/monsters-desires-beasts-tce.md)

![Monsters' Desires; Celestials](Published/tables/monsters-desires-celestials-tce.md)

![Monsters' Desires; Constructs](Published/tables/monsters-desires-constructs-tce.md)

![Monsters' Desires; Dragons](Published/tables/monsters-desires-dragons-tce.md)

![Monsters' Desires; Elementals](Published/tables/monsters-desires-elementals-tce.md)

![Monsters' Desires; Fey](Published/tables/monsters-desires-fey-tce.md)

![Monsters' Desires; Fiends](Published/tables/monsters-desires-fiends-tce.md)

![Monsters' Desires; Giants](Published/tables/monsters-desires-giants-tce.md)

![Monsters' Desires; Humanoids](Published/tables/monsters-desires-humanoids-tce.md)

![Monsters' Desires; Monstrosities](Published/tables/monsters-desires-monstrosities-tce.md)

![Monsters' Desires; Oozes](Published/tables/monsters-desires-oozes-tce.md)

![Monsters' Desires; Plants](Published/tables/monsters-desires-plants-tce.md)

![Monsters' Desires; Undead](Published/tables/monsters-desires-undead-tce.md)
...
![Blessed Radiance Effects](Published/tables/blessed-radiance-effects-tce.md)
...
![Far Realm Effects](Published/tables/far-realm-effects-tce.md)
...
![Haunted Effects](Published/tables/haunted-effects-tce.md)
...
- A creature attacks an insect swarm or a Small or larger insect, such as a [giant centipede](Published/bestiary/beast/giant-centipede.md) or [giant spider](Published/bestiary/beast/giant-spider-xphb.md), in the region.  
...
![Infested Effects](Published/tables/infested-effects-tce.md)
...
![Mirror Zone Effects](Published/tables/mirror-zone-effects-tce.md)
...
![Unraveling Magic Effects](Published/tables/unraveling-magic-effects-tce.md)
...
- [Flaywind](Published/traps-hazards/flaywind-tce.md)  
- [Flame Storm](Published/traps-hazards/flame-storm-tce.md)  
- [Necrotic Tempest](Published/traps-hazards/necrotic-tempest-tce.md)  
- [Thrym's Howl](Published/traps-hazards/thryms-howl-tce.md)  
...
![Enchanted Springs; Enchanted Spring Effects](Published/tables/enchanted-springs-enchanted-spring-effects-tce.md)
...
![Magic Mushrooms; Magic Mushroom Effects](Published/tables/magic-mushrooms-magic-mushroom-effects-tce.md)
...
![Primal Fruit Effects](Published/tables/primal-fruit-effects-tce.md)
...
![Unearthly Roads; Unearthly Road Keys](Published/tables/unearthly-roads-unearthly-road-keys-tce.md)
...
- [Avalanche](Published/traps-hazards/avalanche-tce.md)  
- [Falling into Water](Published/traps-hazards/falling-into-water-tce.md)  
- [Falling onto a Creature](Published/traps-hazards/falling-onto-a-creature-tce.md)  
...
![Spells as Natural Hazards](Published/tables/spells-as-natural-hazards-tce.md)
...
![Creature Paintings](Published/tables/creature-paintings-tce.md)
...
- **Transmutation.** The trap casts polymorph (save DC 15) on the creature that triggered it. On a failed save, the creature turns into a [giant frog](Published/bestiary/beast/giant-frog.md).  
...
Each lock has a creature molded in iron above it: a bat, snake, spider, or wolf, respectively. These locks can't be picked. If anything other than the correct key is placed inside a lock, creatures corresponding to the image above the lock (`1d4` [giant bats](Published/bestiary/beast/giant-bat.md), `1d4` [giant poisonous snakes](Published/bestiary/beast/giant-poisonous-snake.md), `1d4` [giant wolf spiders](Published/bestiary/beast/giant-wolf-spider.md), or `1d4` [wolves](Published/bestiary/beast/wolf-xphb.md)) are summoned into the room. Each summoned creature is hostile and disappears after 10 minutes or when reduced to 0 hit points. These beasts can't be charmed or frightened.
...
![Skeleton Keys Solution](Published/tables/skeleton-keys-solution-tce.md)
...
If a creature attempts to leave the room with any of these stones, the gem disappears and an angry spirit trapped inside it is released. The spirit manifests as a hostile undead creature of your choice, such as a [ghost](Published/bestiary/undead/ghost.md), [specter](Published/bestiary/undead/specter.md), or [skeleton](Published/bestiary/undead/skeleton-xphb.md). When this creature is reduced to 0 hit points, its form dissipates, leaving no trace of itself behind.
...
![Solution; Gem Inventory](Published/tables/solution-gem-inventory-tce.md)
...
A guard stands on the other side of the door around the clock, and the only way to speak with the guard is through the door's slide window. The guard can be any sort of talking creature, such as an [assassin](Published/bestiary/humanoid/assassin.md), a [cult fanatic](Published/bestiary/humanoid/cult-fanatic.md), or a [thug](Published/bestiary/humanoid/thug.md). More monstrous options include a [bugbear](Published/bestiary/humanoid/bugbear.md), [wereboar](Published/bestiary/humanoid/wereboar.md), or [nycaloth](Published/bestiary/fiend/nycaloth.md).
...
![Solution; Potential Passwords](Published/tables/solution-potential-passwords-tce.md)
...
- If the improperly placed tile has an open triangle pointing downward, the [water elemental](Published/bestiary/elemental/water-elemental.md) is freed.  
- If the improperly placed tile has an open triangle pointing upward, the [fire elemental](Published/bestiary/elemental/fire-elemental.md) is freed.  
- If the improperly placed tile has a triangle pointing upward with a horizontal line running through it, the [air elemental](Published/bestiary/elemental/air-elemental.md) is freed.  
- If the improperly placed tile has a triangle pointing downward with a horizontal line running through it, the [earth elemental](Published/bestiary/elemental/earth-elemental.md) is freed.  
...
You can also raise the difficulty by having statues depict genies instead of elementals. In this case, replace the four elementals with a [dao](Published/bestiary/elemental/dao.md), a [djinni](Published/bestiary/elemental/djinni.md), an [efreeti](Published/bestiary/elemental/efreeti.md), and a [marid](Published/bestiary/elemental/marid.md). These genies are compelled to attack the characters and can't be reasoned with.
...
![Solution; Remembered Names](Published/tables/solution-remembered-names-tce.md)
...
![Menu Items](Published/tables/menu-items-tce.md)
...
![What's on the Menu Solution](Published/tables/whats-on-the-menu-solution-tce.md)
