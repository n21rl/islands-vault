...
![Character Options; Subclasses](Published/tables/character-options-subclasses-xge.md)
...
![Parents](Published/tables/parents-xge.md)

![Half-Elf Parents](Published/tables/half-elf-parents-xge.md)

![Half-Orc Parents](Published/tables/half-orc-parents-xge.md)

![Tiefling Parents](Published/tables/tiefling-parents-xge.md)
...
![Birthplace](Published/tables/birthplace-xge.md)
...
![Number of Siblings](Published/tables/number-of-siblings-xge.md)

![Other Details; Birth Order](Published/tables/other-details-birth-order-xge.md)
...
![Supplemental Tables; Family](Published/tables/supplemental-tables-family-xge.md)

![Supplemental Tables; Absent Parent](Published/tables/supplemental-tables-absent-parent-xge.md)

![Supplemental Tables; Family Lifestyle](Published/tables/supplemental-tables-family-lifestyle-xge.md)

![Supplemental Tables; Childhood Home](Published/tables/supplemental-tables-childhood-home-xge.md)

![Supplemental Tables; Childhood Memories](Published/tables/supplemental-tables-childhood-memories-xge.md)
...
![Life Events by Age](Published/tables/life-events-by-age-xge.md)

![Life Events](Published/tables/life-events-xge.md)

#### Secondary Tables

These tables add detail to many of the results on the Life Events table. The tables are in alphabetical order.

![Secondary Tables; Adventures](Published/tables/secondary-tables-adventures-xge.md)

![Secondary Tables; Arcane Matters](Published/tables/secondary-tables-arcane-matters-xge.md)

![Secondary Tables; Boons](Published/tables/secondary-tables-boons-xge.md)

![Secondary Tables; Crime](Published/tables/secondary-tables-crime-xge.md)

![Secondary Tables; Punishment](Published/tables/secondary-tables-punishment-xge.md)

![Secondary Tables; Supernatural Events](Published/tables/secondary-tables-supernatural-events-xge.md)

![Secondary Tables; Tragedies](Published/tables/secondary-tables-tragedies-xge.md)

![Secondary Tables; War](Published/tables/secondary-tables-war-xge.md)

![Secondary Tables; Weird Stuff](Published/tables/secondary-tables-weird-stuff-xge.md)
...
![Supplemental Tables; Alignment](Published/tables/supplemental-tables-alignment-xge.md)

![Supplemental Tables; Cause of Death](Published/tables/supplemental-tables-cause-of-death-xge.md)

![Supplemental Tables; Class](Published/tables/supplemental-tables-class-xge.md)

![Supplemental Tables; Occupation](Published/tables/supplemental-tables-occupation-xge.md)

![Supplemental Tables; Race](Published/tables/supplemental-tables-race-xge.md)

![Supplemental Tables; Relationship](Published/tables/supplemental-tables-relationship-xge.md)

![Supplemental Tables; Status](Published/tables/supplemental-tables-status-xge.md)
...
![Racial Feats](Published/tables/racial-feats-xge.md)
