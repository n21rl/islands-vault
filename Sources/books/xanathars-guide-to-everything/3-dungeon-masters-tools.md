...
The rule for falling assumes that a creature immediately drops the entire distance when it falls. But what if a creature is at a high altitude when it falls, perhaps on the back of a [griffon](Published/bestiary/monstrosity/griffon.md) or on board an airship? Realistically, a fall from such a height can take more than a few seconds, extending past the end of the turn when the fall occurred. If you'd like high-altitude falls to be properly time-consuming, use the following optional rule.
...
Tools have more specific applications than skills. The History skill applies to any event in the past. A tool such as a [forgery kit](Published/items/forgery-kit-xphb.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
See the [Identify a Spell](Published/rules/actions.md#Identify%20a%20Spell) entry.
...
![Determine Numbers and Challenge Ratings; Solo Monster Challenge Rating](Published/tables/determine-numbers-and-challenge-ratings-solo-monster-challenge-rating-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 1st-5th Level](Published/tables/determine-numbers-and-challenge-ratings-multiple-monsters-1st-5th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 6th-10th Level](Published/tables/determine-numbers-and-challenge-ratings-multiple-monsters-6th-10th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 11th-15th Level](Published/tables/determine-numbers-and-challenge-ratings-multiple-monsters-11th-15th-level-xge.md)
...
![Determine Numbers and Challenge Ratings; Multiple Monsters: 16th-20th Level](Published/tables/determine-numbers-and-challenge-ratings-multiple-monsters-16th-20th-level-xge.md)
...
![Monster Personality](Published/tables/monster-personality-xge.md)
...
![Monster Relationships](Published/tables/monster-relationships-xge.md)
...
![Quick Matchups](Published/tables/quick-matchups-xge.md)
...
- [Bear Trap](Published/traps-hazards/bear-trap-xge.md)  
- [Crossbow Trap](Published/traps-hazards/crossbow-trap-xge.md)  
- [Falling Portcullis](Published/traps-hazards/falling-portcullis-xge.md)  
- [Fiery Blast Trap](Published/traps-hazards/fiery-blast-trap-xge.md)  
- [Net Trap](Published/traps-hazards/net-trap-xge.md)  
- [Pit Trap](Published/traps-hazards/pit-trap-xge.md)  
- [Poison Needle Trap](Published/traps-hazards/poison-needle-trap-xge.md)  
- [Scything Blade Trap](Published/traps-hazards/scything-blade-trap-xge.md)  
- [Sleep of Ages Trap](Published/traps-hazards/sleep-of-ages-trap-xge.md)  
...
![Level and Lethality; Trap Save DCs and Attack Bonuses](Published/tables/level-and-lethality-trap-save-dcs-and-attack-bonuses-xge.md)

![Level and Lethality; Damage Severity by Level](Published/tables/level-and-lethality-damage-severity-by-level-xge.md)

![Level and Lethality; Spell Equivalent by Level](Published/tables/level-and-lethality-spell-equivalent-by-level-xge.md)
...
Once you determine how a trap can be disarmed or avoided, decide the appropriate ability and skill combinations that characters can use. A Dexterity check using [thieves' tools](Published/items/thieves-tools-xphb.md), a Strength (Athletics) check, and an Intelligence (Arcana) check are all commonly used for this purpose.

A Dexterity check using [thieves' tools](Published/items/thieves-tools-xphb.md) can apply to any trap that has a mechanical element. [Thieves' tools](Published/items/thieves-tools-xphb.md) can be used to disable a trip wire or a pressure plate, disassemble a poison needle mechanism, or clog a valve that leaks poisonous gas into a room.
...
![Experience for Complex Traps; Complex Trap Experience Awards](Published/tables/experience-for-complex-traps-complex-trap-experience-awards-xge.md)

### Example Complex Traps

The following complex traps can be used to challenge characters or to inspire your own creations.

- [Path of Blades](Published/traps-hazards/path-of-blades-xge.md)  
- [Poisoned Tempest](Published/traps-hazards/poisoned-tempest-xge.md)  
- [Sphere of Crushing Doom](Published/traps-hazards/sphere-of-crushing-doom-xge.md)  
...
![Creating a Rival; Rival](Published/tables/creating-a-rival-rival-xge.md)
...
![Buying a Magic Item; Buying Magic Items](Published/tables/buying-a-magic-item-buying-magic-items-xge.md)

![Buying a Magic Item; Magic Item Price](Published/tables/buying-a-magic-item-magic-item-price-xge.md)
...
![Magic Item Purchase Complications](Published/tables/magic-item-purchase-complications-xge.md)
...
![Carousing](Published/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](Published/tables/lower-class-carousing-complications-xge.md)

![Middle-Class Carousing Complications](Published/tables/middle-class-carousing-complications-xge.md)

![Upper-Class Carousing Complications](Published/tables/upper-class-carousing-complications-xge.md)
...
![Crafting an Item; Resources and Resolution](Published/tables/crafting-an-item-resources-and-resolution-xge.md)
...
![Crafting Magic Items; Magic Item Ingredients](Published/tables/crafting-magic-items-magic-item-ingredients-xge.md)
...
![Crafting Magic Items; Magic Item Crafting Time and Cost](Published/tables/crafting-magic-items-magic-item-crafting-time-and-cost-xge.md)
...
![Crafting Complications](Published/tables/crafting-complications-xge.md)
...
![Brewing Potions of Healing; Potion of Healing Creation](Published/tables/brewing-potions-of-healing-potion-of-healing-creation-xge.md)
...
To attempt a crime, the character makes three checks: Dexterity (Stealth), Dexterity using [thieves' tools](Published/items/thieves-tools-xphb.md), and the player's choice of Intelligence (Investigation), Wisdom (Perception), or Charisma (Deception).
...
![Crime; Loot Value](Published/tables/crime-loot-value-xge.md)
...
![Crime Complications](Published/tables/crime-complications-xge.md)
...
![Gambling Results](Published/tables/gambling-results-xge.md)
...
![Gambling Complications](Published/tables/gambling-complications-xge.md)
...
![Pit Fighting Results](Published/tables/pit-fighting-results-xge.md)
...
![Pit Fighting Complications](Published/tables/pit-fighting-complications-xge.md)
...
![Religious Service](Published/tables/religious-service-xge.md)
...
![Religious Service Complications](Published/tables/religious-service-complications-xge.md)
...
![Research Outcomes](Published/tables/research-outcomes-xge.md)
...
![Research Complications](Published/tables/research-complications-xge.md)
...
![Resources; Spell Scroll Costs](Published/tables/resources-spell-scroll-costs-xge.md)
...
![Scribe a Scroll Complications](Published/tables/scribe-a-scroll-complications-xge.md)
...
![Selling a Magic Item; Magic Item Base Prices](Published/tables/selling-a-magic-item-magic-item-base-prices-xge.md)

![Selling a Magic Item; Magic Item Offer](Published/tables/selling-a-magic-item-magic-item-offer-xge.md)
...
![Magic Item Sale Complications](Published/tables/magic-item-sale-complications-xge.md)
...
![Training Complications](Published/tables/training-complications-xge.md)
...
![Work; Wages](Published/tables/work-wages-xge.md)
...
![Work Complications](Published/tables/work-complications-xge.md)
...
![Distribution by Rarity; Magic Items Awarded by Tier](Published/tables/distribution-by-rarity-magic-items-awarded-by-tier-xge.md)
...
![Magic Items Awarded by Rarity - Minor](Published/tables/magic-items-awarded-by-rarity-minor-xge.md)

![Magic Items Awarded by Rarity - Major](Published/tables/magic-items-awarded-by-rarity-major-xge.md)
