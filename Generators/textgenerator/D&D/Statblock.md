---
PromptInfo:
 promptId: GenStatblock
 name: Generate Statblock
 description: Generate D&D statblock. 
 author: Ant
 tags: fantasy, ttrpg
 version: 0.0.1
---

Prompt: Please provide an appropriate D&D 5e creature stat block for a creature described by {{context}}.
- If an official statblock with the same name exists, use this one
- Use the same formatting as the example below
- Do not change the name of the fields
- Respect the spacing, do not use tabs
- Skip the unnecessary fields
- cr should be a integer
- descriptions (desc) should be surrounded by quotes "like this"
...
spells:
  - The dragon is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 17, +9 to hit with spell attacks). The dragon can cast disguise self and invisibility at will and has the following wizard spells prepared
  ...
  - "* The dragon casts these spells on itself before combat."
```
