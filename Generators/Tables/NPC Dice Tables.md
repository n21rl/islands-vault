...
They are a `dice: [[Race Dice Tables#^main]]`  `dice: [[NPC Dice Tables#^jobs]]` from `dice: #dnd/town|link`. The main color of their clothing is `dice: [[Misc Dice Tables#^color]]`.
...
| --------- | ------------------------------------------------------------------------------------------------------------------------------ |
| 1         | `dice: #person` helps, aids, or works for them                                                                                 |
| 2         | `dice: #person\|link` is out to get them                                                                                       |
| 3         | `dice: [[NPC Dice Tables#^connection-npc-or-faction]]` owes them some `dice: [[NPC Dice Tables#^connections-importance]]` debt |
| 4         | `dice: #person\|link` is from their past `dice: [[NPC Dice Tables#^connections-opinion]]`                                      |
...
| --------- | ----------------------------------------------------------------------------------------------------------------------------- |
| 1         | Helps, Aids, or works for `dice: #person\|link`                                                                              |
| 2         | They are out to get `dice: #person\|link`                                                                                    |
...
| 7         | They know of `dice: #person\|link` from rumors `dice: [[NPC Dice Tables#^connections-rumors]]`, `dice: [[NPC Dice Tables#^connections-opinion]]`                              |
